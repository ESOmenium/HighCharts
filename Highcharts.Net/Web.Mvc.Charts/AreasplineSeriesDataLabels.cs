...
{
	public class AreasplineSeriesDataLabels : BaseObject
	{
		public AreasplineSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private AreasplineSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public AreasplineSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private AreasplineSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public AreasplineSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private AreasplineSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
