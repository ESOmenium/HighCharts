...
{
	public class PlotOptionsTreemapTooltip : BaseObject
	{
		...
		public PlotOptionsTreemapTooltip()
		{
			...
			string str3 = "'&#60;b&#62;{point.name}&#60;/b&#62;: {point.value}&#60;/b&#62;&#60;br/&#62;'";
			str1 = str3;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsTreemapTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
