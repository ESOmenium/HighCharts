...
{
	public class PlotOptionsColumnrangeDataLabels : BaseObject
	{
		public PlotOptionsColumnrangeDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsColumnrangeDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumnrangeDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsColumnrangeDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumnrangeDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsColumnrangeDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsColumnrangeDataLabelsAlign plotOptionsColumnrangeDataLabelsAlign = (PlotOptionsColumnrangeDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsColumnrangeDataLabelsAlign)num;
			this.Align = plotOptionsColumnrangeDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsColumnrangeDataLabelsOverflow plotOptionsColumnrangeDataLabelsOverflow = (PlotOptionsColumnrangeDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsColumnrangeDataLabelsOverflow)num1;
			this.Overflow = plotOptionsColumnrangeDataLabelsOverflow;
			...
			int num2 = 0;
			PlotOptionsColumnrangeDataLabelsVerticalAlign plotOptionsColumnrangeDataLabelsVerticalAlign = (PlotOptionsColumnrangeDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PlotOptionsColumnrangeDataLabelsVerticalAlign)num2;
			this.VerticalAlign = plotOptionsColumnrangeDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsColumnrangeDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsColumnrangeDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsColumnrangeDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsColumnrangeDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
