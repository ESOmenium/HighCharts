...
{
	public class LineSeriesMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public LineSeriesMarkerStates States
		{
			get;
			set;
		}

		private LineSeriesMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public LineSeriesMarker()
		{
			...
			LineSeriesMarkerStates lineSeriesMarkerState = new LineSeriesMarkerStates();
			LineSeriesMarkerStates lineSeriesMarkerState1 = lineSeriesMarkerState;
			this.States_DefaultValue = lineSeriesMarkerState;
			this.States = lineSeriesMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
