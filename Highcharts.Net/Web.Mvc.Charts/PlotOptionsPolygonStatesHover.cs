...
namespace Highsoft.Web.Mvc.Charts
{
	public class PlotOptionsPolygonStatesHover : BaseObject
	{
		...
		public PlotOptionsPolygonStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsPolygonStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsPolygonStatesHover()
		{
			...
			PlotOptionsPolygonStatesHoverHalo plotOptionsPolygonStatesHoverHalo = new PlotOptionsPolygonStatesHoverHalo();
			PlotOptionsPolygonStatesHoverHalo plotOptionsPolygonStatesHoverHalo1 = plotOptionsPolygonStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsPolygonStatesHoverHalo;
			this.Halo = plotOptionsPolygonStatesHoverHalo1;
