...
{
	public class LineSeriesTooltip : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("LineSeriesTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
