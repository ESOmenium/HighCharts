...
{
	public class PlotOptionsPieStatesHover : BaseObject
	{
		...
		public PlotOptionsPieStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsPieStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsPieStatesHover()
		{
			...
			PlotOptionsPieStatesHoverHalo plotOptionsPieStatesHoverHalo = new PlotOptionsPieStatesHoverHalo();
			PlotOptionsPieStatesHoverHalo plotOptionsPieStatesHoverHalo1 = plotOptionsPieStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsPieStatesHoverHalo;
			this.Halo = plotOptionsPieStatesHoverHalo1;
