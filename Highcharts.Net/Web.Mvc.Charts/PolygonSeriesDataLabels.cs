...
{
	public class PolygonSeriesDataLabels : BaseObject
	{
		public PolygonSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private PolygonSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PolygonSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PolygonSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PolygonSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PolygonSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PolygonSeriesDataLabelsAlign polygonSeriesDataLabelsAlign = (PolygonSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (PolygonSeriesDataLabelsAlign)num;
			this.Align = polygonSeriesDataLabelsAlign;
			...
			int num1 = 0;
			PolygonSeriesDataLabelsOverflow polygonSeriesDataLabelsOverflow = (PolygonSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PolygonSeriesDataLabelsOverflow)num1;
			this.Overflow = polygonSeriesDataLabelsOverflow;
			...
			int num2 = 0;
			PolygonSeriesDataLabelsVerticalAlign polygonSeriesDataLabelsVerticalAlign = (PolygonSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PolygonSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign = polygonSeriesDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PolygonSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PolygonSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PolygonSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PolygonSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
