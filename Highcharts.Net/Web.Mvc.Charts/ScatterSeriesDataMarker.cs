...
{
	public class ScatterSeriesDataMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public ScatterSeriesDataMarkerStates States
		{
			get;
			set;
		}

		private ScatterSeriesDataMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public ScatterSeriesDataMarker()
		{
			bool? nullable = null;
			...
			ScatterSeriesDataMarkerStates scatterSeriesDataMarkerState = new ScatterSeriesDataMarkerStates();
			ScatterSeriesDataMarkerStates scatterSeriesDataMarkerState1 = scatterSeriesDataMarkerState;
			this.States_DefaultValue = scatterSeriesDataMarkerState;
			this.States = scatterSeriesDataMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
