...
{
	public class ScatterSeriesStatesHover : BaseObject
	{
		...
		public ScatterSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private ScatterSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public ScatterSeriesStatesHover()
		{
			...
			ScatterSeriesStatesHoverHalo scatterSeriesStatesHoverHalo = new ScatterSeriesStatesHoverHalo();
			ScatterSeriesStatesHoverHalo scatterSeriesStatesHoverHalo1 = scatterSeriesStatesHoverHalo;
			this.Halo_DefaultValue = scatterSeriesStatesHoverHalo;
			this.Halo = scatterSeriesStatesHoverHalo1;
