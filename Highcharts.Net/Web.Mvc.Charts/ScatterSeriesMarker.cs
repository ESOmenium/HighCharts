...
{
	public class ScatterSeriesMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public ScatterSeriesMarkerStates States
		{
			get;
			set;
		}

		private ScatterSeriesMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public ScatterSeriesMarker()
		{
			...
			ScatterSeriesMarkerStates scatterSeriesMarkerState = new ScatterSeriesMarkerStates();
			ScatterSeriesMarkerStates scatterSeriesMarkerState1 = scatterSeriesMarkerState;
			this.States_DefaultValue = scatterSeriesMarkerState;
			this.States = scatterSeriesMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
