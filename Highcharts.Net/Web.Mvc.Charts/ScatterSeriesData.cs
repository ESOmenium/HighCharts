...
namespace Highsoft.Web.Mvc.Charts
{
	public class ScatterSeriesData : BaseObject
	{
		...
		public ScatterSeriesDataEvents Events
		{
			get;
			set;
		}

		private ScatterSeriesDataEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public ScatterSeriesDataMarker Marker
		{
			get;
			set;
		}

		private ScatterSeriesDataMarker Marker_DefaultValue
		{
			get;
			set;
		}
		...
		public ScatterSeriesData()
		{
			...
			this.Drilldown = str;
			ScatterSeriesDataEvents scatterSeriesDataEvent = new ScatterSeriesDataEvents();
			ScatterSeriesDataEvents scatterSeriesDataEvent1 = scatterSeriesDataEvent;
			this.Events_DefaultValue = scatterSeriesDataEvent;
			this.Events = scatterSeriesDataEvent1;
			object obj3 = null;
			str = (string)obj3;
			...
			ScatterSeriesDataMarker scatterSeriesDataMarker = new ScatterSeriesDataMarker();
			ScatterSeriesDataMarker scatterSeriesDataMarker1 = scatterSeriesDataMarker;
			this.Marker_DefaultValue = scatterSeriesDataMarker;
			this.Marker = scatterSeriesDataMarker1;
			object obj4 = null;
			str = (string)obj4;
