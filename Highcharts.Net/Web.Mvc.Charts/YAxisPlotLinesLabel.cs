...
namespace Highsoft.Web.Mvc.Charts
{
	public class YAxisPlotLinesLabel : BaseObject
	{
		...
		public YAxisPlotLinesLabelVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private YAxisPlotLinesLabelVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		public YAxisPlotLinesLabel()
		{
			...
			int num = 0;
			YAxisPlotLinesLabelVerticalAlign yAxisPlotLinesLabelVerticalAlign = (YAxisPlotLinesLabelVerticalAlign)num;
			this.VerticalAlign_DefaultValue = (YAxisPlotLinesLabelVerticalAlign)num;
			this.VerticalAlign = yAxisPlotLinesLabelVerticalAlign;
			nullable = null;
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				YAxisPlotLinesLabelVerticalAlign verticalAlign = this.VerticalAlign;
