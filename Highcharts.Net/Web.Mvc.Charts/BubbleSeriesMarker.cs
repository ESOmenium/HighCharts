...
{
	public class BubbleSeriesMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public BubbleSeriesMarkerStates States
		{
			get;
			set;
		}

		private BubbleSeriesMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public BubbleSeriesMarker()
		{
			...
			BubbleSeriesMarkerStates bubbleSeriesMarkerState = new BubbleSeriesMarkerStates();
			BubbleSeriesMarkerStates bubbleSeriesMarkerState1 = bubbleSeriesMarkerState;
			this.States_DefaultValue = bubbleSeriesMarkerState;
			this.States = bubbleSeriesMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
