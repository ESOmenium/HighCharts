...
namespace Highsoft.Web.Mvc.Charts
{
	public class AreasplinerangeSeriesData : BaseObject
	{
		...
		public AreasplinerangeSeriesDataEvents Events
		{
			get;
			set;
		}

		private AreasplinerangeSeriesDataEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public AreasplinerangeSeriesData()
		{
			...
			this.Drilldown = str;
			AreasplinerangeSeriesDataEvents areasplinerangeSeriesDataEvent = new AreasplinerangeSeriesDataEvents();
			AreasplinerangeSeriesDataEvents areasplinerangeSeriesDataEvent1 = areasplinerangeSeriesDataEvent;
			this.Events_DefaultValue = areasplinerangeSeriesDataEvent;
			this.Events = areasplinerangeSeriesDataEvent1;
			nullable = null;
