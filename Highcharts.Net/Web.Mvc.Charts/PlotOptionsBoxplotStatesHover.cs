...
namespace Highsoft.Web.Mvc.Charts
{
	public class PlotOptionsBoxplotStatesHover : BaseObject
	{
		...
		public PlotOptionsBoxplotStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsBoxplotStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsBoxplotStatesHover()
		{
			...
			PlotOptionsBoxplotStatesHoverHalo plotOptionsBoxplotStatesHoverHalo = new PlotOptionsBoxplotStatesHoverHalo();
			PlotOptionsBoxplotStatesHoverHalo plotOptionsBoxplotStatesHoverHalo1 = plotOptionsBoxplotStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsBoxplotStatesHoverHalo;
			this.Halo = plotOptionsBoxplotStatesHoverHalo1;
