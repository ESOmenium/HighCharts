...
{
	public class BoxplotSeriesTooltip : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("BoxplotSeriesTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
