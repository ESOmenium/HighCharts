...
{
	public class ZAxisCrosshair : BaseObject
	{
		...
		public ZAxisCrosshairDashStyle DashStyle
		{
			get;
			set;
		}

		private ZAxisCrosshairDashStyle DashStyle_DefaultValue
		{
			get;
			set;
		}
		...
		public ZAxisCrosshair()
		{
			...
			this.Color = str1;
			int num = 0;
			ZAxisCrosshairDashStyle zAxisCrosshairDashStyle = (ZAxisCrosshairDashStyle)num;
			this.DashStyle_DefaultValue = (ZAxisCrosshairDashStyle)num;
			this.DashStyle = zAxisCrosshairDashStyle;
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				ZAxisCrosshairDashStyle dashStyle = this.DashStyle;
