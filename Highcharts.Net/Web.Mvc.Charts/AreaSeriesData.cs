...
{
	public class AreaSeriesData : BaseObject
	{
		...
		public AreaSeriesDataEvents Events
		{
			get;
			set;
		}

		private AreaSeriesDataEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesDataMarker Marker
		{
			get;
			set;
		}

		private AreaSeriesDataMarker Marker_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesData()
		{
			...
			this.Drilldown = str;
			AreaSeriesDataEvents areaSeriesDataEvent = new AreaSeriesDataEvents();
			AreaSeriesDataEvents areaSeriesDataEvent1 = areaSeriesDataEvent;
			this.Events_DefaultValue = areaSeriesDataEvent;
			this.Events = areaSeriesDataEvent1;
			object obj3 = null;
			str = (string)obj3;
			...
			AreaSeriesDataMarker areaSeriesDataMarker = new AreaSeriesDataMarker();
			AreaSeriesDataMarker areaSeriesDataMarker1 = areaSeriesDataMarker;
			this.Marker_DefaultValue = areaSeriesDataMarker;
			this.Marker = areaSeriesDataMarker1;
			object obj4 = null;
			str = (string)obj4;
