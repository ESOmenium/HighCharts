...
{
	public class PlotOptionsHeatmapStatesHover : BaseObject
	{
		...
		public PlotOptionsHeatmapStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsHeatmapStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsHeatmapStatesHover()
		{
			...
			PlotOptionsHeatmapStatesHoverHalo plotOptionsHeatmapStatesHoverHalo = new PlotOptionsHeatmapStatesHoverHalo();
			PlotOptionsHeatmapStatesHoverHalo plotOptionsHeatmapStatesHoverHalo1 = plotOptionsHeatmapStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsHeatmapStatesHoverHalo;
			this.Halo = plotOptionsHeatmapStatesHoverHalo1;
