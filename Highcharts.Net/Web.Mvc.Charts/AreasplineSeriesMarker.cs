...
{
	public class AreasplineSeriesMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public AreasplineSeriesMarkerStates States
		{
			get;
			set;
		}

		private AreasplineSeriesMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public AreasplineSeriesMarker()
		{
			...
			AreasplineSeriesMarkerStates areasplineSeriesMarkerState = new AreasplineSeriesMarkerStates();
			AreasplineSeriesMarkerStates areasplineSeriesMarkerState1 = areasplineSeriesMarkerState;
			this.States_DefaultValue = areasplineSeriesMarkerState;
			this.States = areasplineSeriesMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
