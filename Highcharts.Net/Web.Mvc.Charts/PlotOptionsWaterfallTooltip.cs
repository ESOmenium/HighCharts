...
{
	public class PlotOptionsWaterfallTooltip : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsWaterfallTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
