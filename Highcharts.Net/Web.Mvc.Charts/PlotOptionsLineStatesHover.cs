...
{
	public class PlotOptionsLineStatesHover : BaseObject
	{
		...
		public PlotOptionsLineStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsLineStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsLineStatesHover()
		{
			...
			PlotOptionsLineStatesHoverHalo plotOptionsLineStatesHoverHalo = new PlotOptionsLineStatesHoverHalo();
			PlotOptionsLineStatesHoverHalo plotOptionsLineStatesHoverHalo1 = plotOptionsLineStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsLineStatesHoverHalo;
			this.Halo = plotOptionsLineStatesHoverHalo1;
