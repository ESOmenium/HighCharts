...
namespace Highsoft.Web.Mvc.Charts
{
	public class ColumnSeries : Series
	{
		...
		public ColumnSeriesCursor Cursor
		{
			get;
			set;
		}

		private ColumnSeriesCursor Cursor_DefaultValue
		{
			get;
			set;
		}

		public new List<ColumnSeriesData> Data
		{
			get;
			set;
		}

		private List<ColumnSeriesData> Data_DefaultValue
		{
			get;
			set;
		}

		public ColumnSeriesDataLabels DataLabels
		{
			get;
			set;
		}

		private ColumnSeriesDataLabels DataLabels_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnSeriesEvents Events
		{
			get;
			set;
		}

		private ColumnSeriesEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnSeriesPoint Point
		{
			get;
			set;
		}

		private ColumnSeriesPoint Point_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnSeriesPointIntervalUnit PointIntervalUnit
		{
			get;
			set;
		}

		private ColumnSeriesPointIntervalUnit PointIntervalUnit_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnSeriesStacking Stacking
		{
			get;
			set;
		}

		private ColumnSeriesStacking Stacking_DefaultValue
		{
			get;
			set;
		}

		public ColumnSeriesStates States
		{
			get;
			set;
		}

		private ColumnSeriesStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnSeriesTooltip Tooltip
		{
			get;
			set;
		}

		private ColumnSeriesTooltip Tooltip_DefaultValue
		{
			get;
			set;
		}
		...
		public new ColumnSeriesType Type
		{
			get;
			set;
		}

		private ColumnSeriesType Type_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnSeriesZones Zones
		{
			get;
			set;
		}

		private ColumnSeriesZones Zones_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnSeries()
		{
			...
			int num = 0;
			ColumnSeriesCursor columnSeriesCursor = (ColumnSeriesCursor)num;
			this.Cursor_DefaultValue = (ColumnSeriesCursor)num;
			this.Cursor = columnSeriesCursor;
			List<ColumnSeriesData> columnSeriesDatas = new List<ColumnSeriesData>();
			List<ColumnSeriesData> columnSeriesDatas1 = columnSeriesDatas;
			this.Data_DefaultValue = columnSeriesDatas;
			this.Data = columnSeriesDatas1;
			ColumnSeriesDataLabels columnSeriesDataLabel = new ColumnSeriesDataLabels();
			ColumnSeriesDataLabels columnSeriesDataLabel1 = columnSeriesDataLabel;
			this.DataLabels_DefaultValue = columnSeriesDataLabel;
			this.DataLabels = columnSeriesDataLabel1;
			...
			ColumnSeriesEvents columnSeriesEvent = new ColumnSeriesEvents();
			ColumnSeriesEvents columnSeriesEvent1 = columnSeriesEvent;
			this.Events_DefaultValue = columnSeriesEvent;
			this.Events = columnSeriesEvent1;
			nullable = new bool?(false);
			...
			ColumnSeriesPoint columnSeriesPoint = new ColumnSeriesPoint();
			ColumnSeriesPoint columnSeriesPoint1 = columnSeriesPoint;
			this.Point_DefaultValue = columnSeriesPoint;
			this.Point = columnSeriesPoint1;
			nullable1 = new double?((double)1);
			this.PointInterval_DefaultValue = nullable1;
			this.PointInterval = nullable1;
			int num1 = 0;
			ColumnSeriesPointIntervalUnit columnSeriesPointIntervalUnit = (ColumnSeriesPointIntervalUnit)num1;
			this.PointIntervalUnit_DefaultValue = (ColumnSeriesPointIntervalUnit)num1;
			this.PointIntervalUnit = columnSeriesPointIntervalUnit;
			...
			this.Stack = str1;
			int num2 = 0;
			ColumnSeriesStacking columnSeriesStacking = (ColumnSeriesStacking)num2;
			this.Stacking_DefaultValue = (ColumnSeriesStacking)num2;
			this.Stacking = columnSeriesStacking;
			ColumnSeriesStates columnSeriesState = new ColumnSeriesStates();
			ColumnSeriesStates columnSeriesState1 = columnSeriesState;
			this.States_DefaultValue = columnSeriesState;
			this.States = columnSeriesState1;
			nullable = new bool?(true);
			...
			ColumnSeriesTooltip columnSeriesTooltip = new ColumnSeriesTooltip();
			ColumnSeriesTooltip columnSeriesTooltip1 = columnSeriesTooltip;
			this.Tooltip_DefaultValue = columnSeriesTooltip;
			this.Tooltip = columnSeriesTooltip1;
			nullable1 = new double?((double)1000);
			this.TurboThreshold_DefaultValue = nullable1;
			this.TurboThreshold = nullable1;
			int num3 = 0;
			ColumnSeriesType columnSeriesType = (ColumnSeriesType)num3;
			this.Type_DefaultValue = (ColumnSeriesType)num3;
			this.Type = columnSeriesType;
			nullable = new bool?(true);
			...
			this.ZoneAxis = str1;
			ColumnSeriesZones columnSeriesZone = new ColumnSeriesZones();
			ColumnSeriesZones columnSeriesZone1 = columnSeriesZone;
			this.Zones_DefaultValue = columnSeriesZone;
			this.Zones = columnSeriesZone1;
		}
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				ColumnSeriesCursor cursor = this.Cursor;
			...
			{
				ColumnSeriesPointIntervalUnit pointIntervalUnit = this.PointIntervalUnit;
			...
			{
				ColumnSeriesStacking stacking = this.Stacking;
			...
			{
				ColumnSeriesType type = this.Type;
