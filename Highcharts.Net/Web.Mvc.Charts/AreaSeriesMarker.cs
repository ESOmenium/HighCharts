...
{
	public class AreaSeriesMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public AreaSeriesMarkerStates States
		{
			get;
			set;
		}

		private AreaSeriesMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesMarker()
		{
			...
			AreaSeriesMarkerStates areaSeriesMarkerState = new AreaSeriesMarkerStates();
			AreaSeriesMarkerStates areaSeriesMarkerState1 = areaSeriesMarkerState;
			this.States_DefaultValue = areaSeriesMarkerState;
			this.States = areaSeriesMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
