...
{
	public class SplineSeriesDataLabels : BaseObject
	{
		public SplineSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private SplineSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public SplineSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private SplineSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public SplineSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private SplineSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			SplineSeriesDataLabelsAlign splineSeriesDataLabelsAlign = (SplineSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (SplineSeriesDataLabelsAlign)num;
			this.Align = splineSeriesDataLabelsAlign;
			...
			int num1 = 0;
			SplineSeriesDataLabelsOverflow splineSeriesDataLabelsOverflow = (SplineSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (SplineSeriesDataLabelsOverflow)num1;
			this.Overflow = splineSeriesDataLabelsOverflow;
			...
			int num2 = 0;
			SplineSeriesDataLabelsVerticalAlign splineSeriesDataLabelsVerticalAlign = (SplineSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (SplineSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign = splineSeriesDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				SplineSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("SplineSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				SplineSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				SplineSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
