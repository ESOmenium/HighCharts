...
{
	public class PlotOptionsSeriesDataLabels : BaseObject
	{
		public PlotOptionsSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesDataLabels()
		{
			int num = 1;
			PlotOptionsSeriesDataLabelsAlign plotOptionsSeriesDataLabelsAlign = (PlotOptionsSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsSeriesDataLabelsAlign)num;
			this.Align = plotOptionsSeriesDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsSeriesDataLabelsOverflow plotOptionsSeriesDataLabelsOverflow = (PlotOptionsSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsSeriesDataLabelsOverflow)num1;
			this.Overflow = plotOptionsSeriesDataLabelsOverflow;
			...
			int num2 = 0;
			PlotOptionsSeriesDataLabelsVerticalAlign plotOptionsSeriesDataLabelsVerticalAlign = (PlotOptionsSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PlotOptionsSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign = plotOptionsSeriesDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
