...
{
	public class PlotOptionsColumnStatesHover : BaseObject
	{
		...
		public PlotOptionsColumnStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsColumnStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumnStatesHover()
		{
			...
			PlotOptionsColumnStatesHoverHalo plotOptionsColumnStatesHoverHalo = new PlotOptionsColumnStatesHoverHalo();
			PlotOptionsColumnStatesHoverHalo plotOptionsColumnStatesHoverHalo1 = plotOptionsColumnStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsColumnStatesHoverHalo;
			this.Halo = plotOptionsColumnStatesHoverHalo1;
