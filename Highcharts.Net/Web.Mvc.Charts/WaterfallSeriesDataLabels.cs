...
{
	public class WaterfallSeriesDataLabels : BaseObject
	{
		public WaterfallSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private WaterfallSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public WaterfallSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private WaterfallSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public WaterfallSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private WaterfallSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			WaterfallSeriesDataLabelsAlign waterfallSeriesDataLabelsAlign = (WaterfallSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (WaterfallSeriesDataLabelsAlign)num;
			this.Align = waterfallSeriesDataLabelsAlign;
			...
			int num1 = 0;
			WaterfallSeriesDataLabelsOverflow waterfallSeriesDataLabelsOverflow = (WaterfallSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (WaterfallSeriesDataLabelsOverflow)num1;
			this.Overflow = waterfallSeriesDataLabelsOverflow;
			...
			int num2 = 0;
			WaterfallSeriesDataLabelsVerticalAlign waterfallSeriesDataLabelsVerticalAlign = (WaterfallSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (WaterfallSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign = waterfallSeriesDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				WaterfallSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("WaterfallSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				WaterfallSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				WaterfallSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
