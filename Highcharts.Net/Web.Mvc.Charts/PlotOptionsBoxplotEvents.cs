...
{
	public class PlotOptionsBoxplotEvents : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.AfterAnimate != this.AfterAnimate_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsBoxplotEventsAfterAnimate.afterAnimate", this.AfterAnimate);
			}
			if (this.CheckboxClick != this.CheckboxClick_DefaultValue)
			{
				hashtables.Add("checkboxClick", this.CheckboxClick);
				Highcharts.AddFunction("PlotOptionsBoxplotEventsCheckboxClick.checkboxClick", this.CheckboxClick);
			}
			if (this.Click != this.Click_DefaultValue)
			{
				hashtables.Add("click", this.Click);
				Highcharts.AddFunction("PlotOptionsBoxplotEventsClick.click", this.Click);
			}
			if (this.Hide != this.Hide_DefaultValue)
			{
				hashtables.Add("hide", this.Hide);
				Highcharts.AddFunction("PlotOptionsBoxplotEventsHide.hide", this.Hide);
			}
			if (this.LegendItemClick != this.LegendItemClick_DefaultValue)
			{
				hashtables.Add("legendItemClick", this.LegendItemClick);
				Highcharts.AddFunction("PlotOptionsBoxplotEventsLegendItemClick.legendItemClick", this.LegendItemClick);
			}
			if (this.MouseOut != this.MouseOut_DefaultValue)
			{
				hashtables.Add("mouseOut", this.MouseOut);
				Highcharts.AddFunction("PlotOptionsBoxplotEventsMouseOut.mouseOut", this.MouseOut);
			}
			if (this.MouseOver != this.MouseOver_DefaultValue)
			{
				hashtables.Add("mouseOver", this.MouseOver);
				Highcharts.AddFunction("PlotOptionsBoxplotEventsMouseOver.mouseOver", this.MouseOver);
			}
			if (this.Show != this.Show_DefaultValue)
			{
				hashtables.Add("show", this.Show);
				Highcharts.AddFunction("PlotOptionsBoxplotEventsShow.show", this.Show);
			}
			return hashtables;
		}
