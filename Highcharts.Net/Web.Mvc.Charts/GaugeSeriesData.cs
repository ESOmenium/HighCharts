...
namespace Highsoft.Web.Mvc.Charts
{
	public class GaugeSeriesData : BaseObject
	{
		...
		public GaugeSeriesDataEvents Events
		{
			get;
			set;
		}

		private GaugeSeriesDataEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public GaugeSeriesData()
		{
			...
			GaugeSeriesDataEvents gaugeSeriesDataEvent = new GaugeSeriesDataEvents();
			GaugeSeriesDataEvents gaugeSeriesDataEvent1 = gaugeSeriesDataEvent;
			this.Events_DefaultValue = gaugeSeriesDataEvent;
			this.Events = gaugeSeriesDataEvent1;
			object obj3 = null;
			str = (string)obj3;
