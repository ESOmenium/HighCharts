...
namespace Highsoft.Web.Mvc.Charts
{
	...
	{
		public ColumnrangeSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private ColumnrangeSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnrangeSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private ColumnrangeSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnrangeSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private ColumnrangeSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			ColumnrangeSeriesDataLabelsAlign columnrangeSeriesDataLabelsAlign = (ColumnrangeSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (ColumnrangeSeriesDataLabelsAlign)num;
			this.Align = columnrangeSeriesDataLabelsAlign;
			...
			int num1 = 0;
			ColumnrangeSeriesDataLabelsOverflow columnrangeSeriesDataLabelsOverflow = (ColumnrangeSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (ColumnrangeSeriesDataLabelsOverflow)num1;
			this.Overflow = columnrangeSeriesDataLabelsOverflow;
			...
			int num2 = 0;
			ColumnrangeSeriesDataLabelsVerticalAlign columnrangeSeriesDataLabelsVerticalAlign = (ColumnrangeSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (ColumnrangeSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign = columnrangeSeriesDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				ColumnrangeSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("ColumnrangeSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				ColumnrangeSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				ColumnrangeSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
