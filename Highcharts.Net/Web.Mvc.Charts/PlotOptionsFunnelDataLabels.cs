...
namespace Highsoft.Web.Mvc.Charts
{
	public class PlotOptionsFunnelDataLabels : BaseObject
	{
		...
		public PlotOptionsFunnelDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsFunnelDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsFunnelDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsFunnelDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
