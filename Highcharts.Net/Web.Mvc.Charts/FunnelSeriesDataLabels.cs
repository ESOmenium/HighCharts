...
{
	public class FunnelSeriesDataLabels : BaseObject
	{
		...
		public FunnelSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private FunnelSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public FunnelSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private FunnelSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		public FunnelSeriesDataLabels()
		{
			...
			int num = 0;
			FunnelSeriesDataLabelsOverflow funnelSeriesDataLabelsOverflow = (FunnelSeriesDataLabelsOverflow)num;
			this.Overflow_DefaultValue = (FunnelSeriesDataLabelsOverflow)num;
			this.Overflow = funnelSeriesDataLabelsOverflow;
			nullable = new double?((double)5);
			...
			int num1 = 0;
			FunnelSeriesDataLabelsVerticalAlign funnelSeriesDataLabelsVerticalAlign = (FunnelSeriesDataLabelsVerticalAlign)num1;
			this.VerticalAlign_DefaultValue = (FunnelSeriesDataLabelsVerticalAlign)num1;
			this.VerticalAlign = funnelSeriesDataLabelsVerticalAlign;
			nullable = new double?(0);
