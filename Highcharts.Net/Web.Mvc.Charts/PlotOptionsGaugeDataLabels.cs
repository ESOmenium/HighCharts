...
{
	public class PlotOptionsGaugeDataLabels : BaseObject
	{
		public PlotOptionsGaugeDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsGaugeDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsGaugeDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsGaugeDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsGaugeDataLabelsAlign plotOptionsGaugeDataLabelsAlign = (PlotOptionsGaugeDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsGaugeDataLabelsAlign)num;
			this.Align = plotOptionsGaugeDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsGaugeDataLabelsOverflow plotOptionsGaugeDataLabelsOverflow = (PlotOptionsGaugeDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsGaugeDataLabelsOverflow)num1;
			this.Overflow = plotOptionsGaugeDataLabelsOverflow;
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsGaugeDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsGaugeDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsGaugeDataLabelsOverflow overflow = this.Overflow;
