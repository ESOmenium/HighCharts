...
{
	public class PlotOptionsPyramidStatesHover : BaseObject
	{
		...
		public PlotOptionsPyramidStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsPyramidStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsPyramidStatesHover()
		{
			...
			PlotOptionsPyramidStatesHoverHalo plotOptionsPyramidStatesHoverHalo = new PlotOptionsPyramidStatesHoverHalo();
			PlotOptionsPyramidStatesHoverHalo plotOptionsPyramidStatesHoverHalo1 = plotOptionsPyramidStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsPyramidStatesHoverHalo;
			this.Halo = plotOptionsPyramidStatesHoverHalo1;
