...
{
	public class PlotOptionsAreasplinerangeTooltip : BaseObject
	{
		...
		public PlotOptionsAreasplinerangeTooltip()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsAreasplinerangeTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
