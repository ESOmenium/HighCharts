...
{
	public class PieSeriesDataLabels : BaseObject
	{
		...
		public PieSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PieSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PieSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PieSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		public PieSeriesDataLabels()
		{
			...
			int num = 0;
			PieSeriesDataLabelsOverflow pieSeriesDataLabelsOverflow = (PieSeriesDataLabelsOverflow)num;
			this.Overflow_DefaultValue = (PieSeriesDataLabelsOverflow)num;
			this.Overflow = pieSeriesDataLabelsOverflow;
			nullable = new double?((double)5);
			...
			int num1 = 0;
			PieSeriesDataLabelsVerticalAlign pieSeriesDataLabelsVerticalAlign = (PieSeriesDataLabelsVerticalAlign)num1;
			this.VerticalAlign_DefaultValue = (PieSeriesDataLabelsVerticalAlign)num1;
			this.VerticalAlign = pieSeriesDataLabelsVerticalAlign;
			nullable = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PieSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PieSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
