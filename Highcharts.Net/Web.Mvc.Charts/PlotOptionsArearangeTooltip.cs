...
{
	public class PlotOptionsArearangeTooltip : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsArearangeTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
