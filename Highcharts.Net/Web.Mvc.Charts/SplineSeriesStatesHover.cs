...
namespace Highsoft.Web.Mvc.Charts
{
	public class SplineSeriesStatesHover : BaseObject
	{
		...
		public SplineSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private SplineSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public SplineSeriesStatesHover()
		{
			...
			SplineSeriesStatesHoverHalo splineSeriesStatesHoverHalo = new SplineSeriesStatesHoverHalo();
			SplineSeriesStatesHoverHalo splineSeriesStatesHoverHalo1 = splineSeriesStatesHoverHalo;
			this.Halo_DefaultValue = splineSeriesStatesHoverHalo;
			this.Halo = splineSeriesStatesHoverHalo1;
