...
{
	public class AreasplinerangeSeriesTooltip : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("AreasplinerangeSeriesTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
