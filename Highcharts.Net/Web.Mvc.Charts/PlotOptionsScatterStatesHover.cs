...
{
	public class PlotOptionsScatterStatesHover : BaseObject
	{
		...
		public PlotOptionsScatterStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsScatterStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsScatterStatesHover()
		{
			...
			PlotOptionsScatterStatesHoverHalo plotOptionsScatterStatesHoverHalo = new PlotOptionsScatterStatesHoverHalo();
			PlotOptionsScatterStatesHoverHalo plotOptionsScatterStatesHoverHalo1 = plotOptionsScatterStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsScatterStatesHoverHalo;
			this.Halo = plotOptionsScatterStatesHoverHalo1;
