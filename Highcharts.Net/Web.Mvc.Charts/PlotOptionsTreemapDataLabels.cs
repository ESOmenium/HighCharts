...
{
	public class PlotOptionsTreemapDataLabels : BaseObject
	{
		public PlotOptionsTreemapDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsTreemapDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsTreemapDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsTreemapDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsTreemapDataLabelsAlign plotOptionsTreemapDataLabelsAlign = (PlotOptionsTreemapDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsTreemapDataLabelsAlign)num;
			this.Align = plotOptionsTreemapDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsTreemapDataLabelsOverflow plotOptionsTreemapDataLabelsOverflow = (PlotOptionsTreemapDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsTreemapDataLabelsOverflow)num1;
			this.Overflow = plotOptionsTreemapDataLabelsOverflow;
			...
			string str4 = "middle";
			str = str4;
			this.VerticalAlign_DefaultValue = str4;
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsTreemapDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsTreemapDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsTreemapDataLabelsOverflow overflow = this.Overflow;
