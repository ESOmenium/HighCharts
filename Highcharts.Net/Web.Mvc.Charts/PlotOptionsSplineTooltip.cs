...
{
	public class PlotOptionsSplineTooltip : BaseObject
	{
		...
		public PlotOptionsSplineTooltip()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsSplineTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
