...
{
	public class PlotOptionsLineDataLabels : BaseObject
	{
		public PlotOptionsLineDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsLineDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsLineDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsLineDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsLineDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsLineDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsLineDataLabelsAlign plotOptionsLineDataLabelsAlign = (PlotOptionsLineDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsLineDataLabelsAlign)num;
			this.Align = plotOptionsLineDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsLineDataLabelsOverflow plotOptionsLineDataLabelsOverflow = (PlotOptionsLineDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsLineDataLabelsOverflow)num1;
			this.Overflow = plotOptionsLineDataLabelsOverflow;
			...
			int num2 = 0;
			PlotOptionsLineDataLabelsVerticalAlign plotOptionsLineDataLabelsVerticalAlign = (PlotOptionsLineDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PlotOptionsLineDataLabelsVerticalAlign)num2;
			this.VerticalAlign = plotOptionsLineDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsLineDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsLineDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsLineDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsLineDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
