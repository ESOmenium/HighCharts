...
namespace Highsoft.Web.Mvc.Charts
{
	public class BarSeriesData : BaseObject
	{
		...
		public BarSeriesDataEvents Events
		{
			get;
			set;
		}

		private BarSeriesDataEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public BarSeriesData()
		{
			...
			this.Drilldown = str;
			BarSeriesDataEvents barSeriesDataEvent = new BarSeriesDataEvents();
			BarSeriesDataEvents barSeriesDataEvent1 = barSeriesDataEvent;
			this.Events_DefaultValue = barSeriesDataEvent;
			this.Events = barSeriesDataEvent1;
			object obj3 = null;
			str = (string)obj3;
