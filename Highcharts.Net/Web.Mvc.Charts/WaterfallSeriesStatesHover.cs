...
{
	public class WaterfallSeriesStatesHover : BaseObject
	{
		...
		public WaterfallSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private WaterfallSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public WaterfallSeriesStatesHover()
		{
			...
			WaterfallSeriesStatesHoverHalo waterfallSeriesStatesHoverHalo = new WaterfallSeriesStatesHoverHalo();
			WaterfallSeriesStatesHoverHalo waterfallSeriesStatesHoverHalo1 = waterfallSeriesStatesHoverHalo;
			this.Halo_DefaultValue = waterfallSeriesStatesHoverHalo;
			this.Halo = waterfallSeriesStatesHoverHalo1;
