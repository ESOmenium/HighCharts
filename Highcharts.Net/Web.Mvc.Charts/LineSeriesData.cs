...
namespace Highsoft.Web.Mvc.Charts
{
	public class LineSeriesData : BaseObject
	{
		...
		public LineSeriesDataEvents Events
		{
			get;
			set;
		}

		private LineSeriesDataEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public LineSeriesDataMarker Marker
		{
			get;
			set;
		}

		private LineSeriesDataMarker Marker_DefaultValue
		{
			get;
			set;
		}
		...
		public LineSeriesData()
		{
			...
			this.Drilldown = str;
			LineSeriesDataEvents lineSeriesDataEvent = new LineSeriesDataEvents();
			LineSeriesDataEvents lineSeriesDataEvent1 = lineSeriesDataEvent;
			this.Events_DefaultValue = lineSeriesDataEvent;
			this.Events = lineSeriesDataEvent1;
			object obj3 = null;
			str = (string)obj3;
			...
			LineSeriesDataMarker lineSeriesDataMarker = new LineSeriesDataMarker();
			LineSeriesDataMarker lineSeriesDataMarker1 = lineSeriesDataMarker;
			this.Marker_DefaultValue = lineSeriesDataMarker;
			this.Marker = lineSeriesDataMarker1;
			object obj4 = null;
			str = (string)obj4;
