...
namespace Highsoft.Web.Mvc.Charts
{
	public class PlotOptionsSplineStatesHover : BaseObject
	{
		...
		public PlotOptionsSplineStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsSplineStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSplineStatesHover()
		{
			...
			PlotOptionsSplineStatesHoverHalo plotOptionsSplineStatesHoverHalo = new PlotOptionsSplineStatesHoverHalo();
			PlotOptionsSplineStatesHoverHalo plotOptionsSplineStatesHoverHalo1 = plotOptionsSplineStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsSplineStatesHoverHalo;
			this.Halo = plotOptionsSplineStatesHoverHalo1;
