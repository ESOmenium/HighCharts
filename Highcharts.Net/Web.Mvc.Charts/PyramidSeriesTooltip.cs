...
{
	public class PyramidSeriesTooltip : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PyramidSeriesTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
