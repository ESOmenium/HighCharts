...
{
	public class PlotOptionsAreasplinerangeDataLabels : BaseObject
	{
		public PlotOptionsAreasplinerangeDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsAreasplinerangeDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsAreasplinerangeDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsAreasplinerangeDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsAreasplinerangeDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsAreasplinerangeDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		private double? XHigh_DefaultValue
		{
			get;
			set;
		}
		...
		private double? XLow_DefaultValue
		{
			get;
			set;
		}
		...
		private double? YHigh_DefaultValue
		{
			get;
			set;
		}
		...
		private double? YLow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsAreasplinerangeDataLabels()
		{
			int num = 1;
			PlotOptionsAreasplinerangeDataLabelsAlign plotOptionsAreasplinerangeDataLabelsAlign = (PlotOptionsAreasplinerangeDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsAreasplinerangeDataLabelsAlign)num;
			this.Align = plotOptionsAreasplinerangeDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsAreasplinerangeDataLabelsOverflow plotOptionsAreasplinerangeDataLabelsOverflow = (PlotOptionsAreasplinerangeDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsAreasplinerangeDataLabelsOverflow)num1;
			this.Overflow = plotOptionsAreasplinerangeDataLabelsOverflow;
			...
			int num2 = 0;
			PlotOptionsAreasplinerangeDataLabelsVerticalAlign plotOptionsAreasplinerangeDataLabelsVerticalAlign = (PlotOptionsAreasplinerangeDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PlotOptionsAreasplinerangeDataLabelsVerticalAlign)num2;
			this.VerticalAlign = plotOptionsAreasplinerangeDataLabelsVerticalAlign;
			nullable1 = new double?(0);
			this.XHigh_DefaultValue = nullable1;
			this.XHigh = nullable1;
			nullable1 = new double?(0);
			this.XLow_DefaultValue = nullable1;
			this.XLow = nullable1;
			nullable1 = new double?((double)-6);
			this.YHigh_DefaultValue = nullable1;
			this.YHigh = nullable1;
			nullable1 = new double?((double)16);
			this.YLow_DefaultValue = nullable1;
			this.YLow = nullable1;
			nullable1 = new double?((double)6);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsAreasplinerangeDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsAreasplinerangeDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsAreasplinerangeDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsAreasplinerangeDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
				hashtables.Add("verticalAlign", Highcharts.FirstCharacterToLower(verticalAlign.ToString()));
			}
			borderRadius = this.XHigh;
			borderRadiusDefaultValue = this.XHigh_DefaultValue;
			if ((borderRadius.GetValueOrDefault() == borderRadiusDefaultValue.GetValueOrDefault() ? borderRadius.HasValue != borderRadiusDefaultValue.HasValue : true))
			{
				hashtables.Add("xHigh", this.XHigh);
			}
			borderRadiusDefaultValue = this.XLow;
			borderRadius = this.XLow_DefaultValue;
			if ((borderRadiusDefaultValue.GetValueOrDefault() == borderRadius.GetValueOrDefault() ? borderRadiusDefaultValue.HasValue != borderRadius.HasValue : true))
			{
				hashtables.Add("xLow", this.XLow);
			}
			borderRadius = this.YHigh;
			borderRadiusDefaultValue = this.YHigh_DefaultValue;
			if ((borderRadius.GetValueOrDefault() == borderRadiusDefaultValue.GetValueOrDefault() ? borderRadius.HasValue != borderRadiusDefaultValue.HasValue : true))
			{
				hashtables.Add("yHigh", this.YHigh);
			}
			borderRadiusDefaultValue = this.YLow;
			borderRadius = this.YLow_DefaultValue;
			if ((borderRadiusDefaultValue.GetValueOrDefault() == borderRadius.GetValueOrDefault() ? borderRadiusDefaultValue.HasValue != borderRadius.HasValue : true))
			{
				hashtables.Add("yLow", this.YLow);
			}
