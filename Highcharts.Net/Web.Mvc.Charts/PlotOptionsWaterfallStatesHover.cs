...
{
	public class PlotOptionsWaterfallStatesHover : BaseObject
	{
		...
		public PlotOptionsWaterfallStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsWaterfallStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsWaterfallStatesHover()
		{
			...
			PlotOptionsWaterfallStatesHoverHalo plotOptionsWaterfallStatesHoverHalo = new PlotOptionsWaterfallStatesHoverHalo();
			PlotOptionsWaterfallStatesHoverHalo plotOptionsWaterfallStatesHoverHalo1 = plotOptionsWaterfallStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsWaterfallStatesHoverHalo;
			this.Halo = plotOptionsWaterfallStatesHoverHalo1;
