...
{
	public class PlotOptionsSeriesMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public PlotOptionsSeriesMarkerStates States
		{
			get;
			set;
		}

		private PlotOptionsSeriesMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesMarker()
		{
			bool? nullable = null;
			...
			PlotOptionsSeriesMarkerStates plotOptionsSeriesMarkerState = new PlotOptionsSeriesMarkerStates();
			PlotOptionsSeriesMarkerStates plotOptionsSeriesMarkerState1 = plotOptionsSeriesMarkerState;
			this.States_DefaultValue = plotOptionsSeriesMarkerState;
			this.States = plotOptionsSeriesMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
