...
{
	public class AreaSeriesDataMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public AreaSeriesDataMarkerStates States
		{
			get;
			set;
		}

		private AreaSeriesDataMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesDataMarker()
		{
			...
			AreaSeriesDataMarkerStates areaSeriesDataMarkerState = new AreaSeriesDataMarkerStates();
			AreaSeriesDataMarkerStates areaSeriesDataMarkerState1 = areaSeriesDataMarkerState;
			this.States_DefaultValue = areaSeriesDataMarkerState;
			this.States = areaSeriesDataMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
