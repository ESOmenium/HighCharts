...
{
	public class PlotOptionsHeatmapDataLabels : BaseObject
	{
		public PlotOptionsHeatmapDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsHeatmapDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsHeatmapDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsHeatmapDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsHeatmapDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsHeatmapDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsHeatmapDataLabelsAlign plotOptionsHeatmapDataLabelsAlign = (PlotOptionsHeatmapDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsHeatmapDataLabelsAlign)num;
			this.Align = plotOptionsHeatmapDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsHeatmapDataLabelsOverflow plotOptionsHeatmapDataLabelsOverflow = (PlotOptionsHeatmapDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsHeatmapDataLabelsOverflow)num1;
			this.Overflow = plotOptionsHeatmapDataLabelsOverflow;
			...
			int num2 = 0;
			PlotOptionsHeatmapDataLabelsVerticalAlign plotOptionsHeatmapDataLabelsVerticalAlign = (PlotOptionsHeatmapDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PlotOptionsHeatmapDataLabelsVerticalAlign)num2;
			this.VerticalAlign = plotOptionsHeatmapDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsHeatmapDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsHeatmapDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsHeatmapDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsHeatmapDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
