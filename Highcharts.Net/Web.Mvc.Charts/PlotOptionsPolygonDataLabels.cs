...
namespace Highsoft.Web.Mvc.Charts
{
	...
	{
		public PlotOptionsPolygonDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsPolygonDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsPolygonDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsPolygonDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsPolygonDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsPolygonDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsPolygonDataLabelsAlign plotOptionsPolygonDataLabelsAlign = (PlotOptionsPolygonDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsPolygonDataLabelsAlign)num;
			this.Align = plotOptionsPolygonDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsPolygonDataLabelsOverflow plotOptionsPolygonDataLabelsOverflow = (PlotOptionsPolygonDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsPolygonDataLabelsOverflow)num1;
			this.Overflow = plotOptionsPolygonDataLabelsOverflow;
			...
			int num2 = 0;
			PlotOptionsPolygonDataLabelsVerticalAlign plotOptionsPolygonDataLabelsVerticalAlign = (PlotOptionsPolygonDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PlotOptionsPolygonDataLabelsVerticalAlign)num2;
			this.VerticalAlign = plotOptionsPolygonDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsPolygonDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsPolygonDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsPolygonDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsPolygonDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
