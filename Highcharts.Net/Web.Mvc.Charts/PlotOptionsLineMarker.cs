...
{
	public class PlotOptionsLineMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public PlotOptionsLineMarkerStates States
		{
			get;
			set;
		}

		private PlotOptionsLineMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsLineMarker()
		{
			...
			PlotOptionsLineMarkerStates plotOptionsLineMarkerState = new PlotOptionsLineMarkerStates();
			PlotOptionsLineMarkerStates plotOptionsLineMarkerState1 = plotOptionsLineMarkerState;
			this.States_DefaultValue = plotOptionsLineMarkerState;
			this.States = plotOptionsLineMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
