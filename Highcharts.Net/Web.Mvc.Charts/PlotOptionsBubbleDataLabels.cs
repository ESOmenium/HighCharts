...
{
	public class PlotOptionsBubbleDataLabels : BaseObject
	{
		public PlotOptionsBubbleDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsBubbleDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsBubbleDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsBubbleDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsBubbleDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsBubbleDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsBubbleDataLabelsAlign plotOptionsBubbleDataLabelsAlign = (PlotOptionsBubbleDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsBubbleDataLabelsAlign)num;
			this.Align = plotOptionsBubbleDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsBubbleDataLabelsOverflow plotOptionsBubbleDataLabelsOverflow = (PlotOptionsBubbleDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsBubbleDataLabelsOverflow)num1;
			this.Overflow = plotOptionsBubbleDataLabelsOverflow;
			...
			int num2 = 0;
			PlotOptionsBubbleDataLabelsVerticalAlign plotOptionsBubbleDataLabelsVerticalAlign = (PlotOptionsBubbleDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PlotOptionsBubbleDataLabelsVerticalAlign)num2;
			this.VerticalAlign = plotOptionsBubbleDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsBubbleDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsBubbleDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsBubbleDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsBubbleDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
