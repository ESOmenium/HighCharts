...
{
	public class HeatmapSeriesDataLabels : BaseObject
	{
		public HeatmapSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private HeatmapSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public HeatmapSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private HeatmapSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public HeatmapSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private HeatmapSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			HeatmapSeriesDataLabelsAlign heatmapSeriesDataLabelsAlign = (HeatmapSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (HeatmapSeriesDataLabelsAlign)num;
			this.Align = heatmapSeriesDataLabelsAlign;
			...
			int num1 = 0;
			HeatmapSeriesDataLabelsOverflow heatmapSeriesDataLabelsOverflow = (HeatmapSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (HeatmapSeriesDataLabelsOverflow)num1;
			this.Overflow = heatmapSeriesDataLabelsOverflow;
			...
			int num2 = 0;
			HeatmapSeriesDataLabelsVerticalAlign heatmapSeriesDataLabelsVerticalAlign = (HeatmapSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (HeatmapSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign = heatmapSeriesDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				HeatmapSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("HeatmapSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				HeatmapSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				HeatmapSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
