...
{
	public class XAxisPlotLines : BaseObject
	{
		...
		public XAxisPlotLinesDashStyle DashStyle
		{
			get;
			set;
		}

		private XAxisPlotLinesDashStyle DashStyle_DefaultValue
		{
			get;
			set;
		}
		...
		public XAxisPlotLinesLabel Label
		{
			get;
			set;
		}

		private XAxisPlotLinesLabel Label_DefaultValue
		{
			get;
			set;
		}
		...
		public XAxisPlotLines()
		{
			...
			this.Color = str1;
			int num = 0;
			XAxisPlotLinesDashStyle xAxisPlotLinesDashStyle = (XAxisPlotLinesDashStyle)num;
			this.DashStyle_DefaultValue = (XAxisPlotLinesDashStyle)num;
			this.DashStyle = xAxisPlotLinesDashStyle;
			object obj1 = null;
			object obj2 = obj1;
			...
			this.Id = str1;
			XAxisPlotLinesLabel xAxisPlotLinesLabel = new XAxisPlotLinesLabel();
			XAxisPlotLinesLabel xAxisPlotLinesLabel1 = xAxisPlotLinesLabel;
			this.Label_DefaultValue = xAxisPlotLinesLabel;
			this.Label = xAxisPlotLinesLabel1;
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				XAxisPlotLinesDashStyle dashStyle = this.DashStyle;
