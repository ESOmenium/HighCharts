...
{
	public class PlotOptionsAreaStatesHover : BaseObject
	{
		...
		public PlotOptionsAreaStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsAreaStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsAreaStatesHover()
		{
			...
			PlotOptionsAreaStatesHoverHalo plotOptionsAreaStatesHoverHalo = new PlotOptionsAreaStatesHoverHalo();
			PlotOptionsAreaStatesHoverHalo plotOptionsAreaStatesHoverHalo1 = plotOptionsAreaStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsAreaStatesHoverHalo;
			this.Halo = plotOptionsAreaStatesHoverHalo1;
