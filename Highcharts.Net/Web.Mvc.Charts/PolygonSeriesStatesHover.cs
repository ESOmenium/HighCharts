...
{
	public class PolygonSeriesStatesHover : BaseObject
	{
		...
		public PolygonSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PolygonSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PolygonSeriesStatesHover()
		{
			...
			PolygonSeriesStatesHoverHalo polygonSeriesStatesHoverHalo = new PolygonSeriesStatesHoverHalo();
			PolygonSeriesStatesHoverHalo polygonSeriesStatesHoverHalo1 = polygonSeriesStatesHoverHalo;
			this.Halo_DefaultValue = polygonSeriesStatesHoverHalo;
			this.Halo = polygonSeriesStatesHoverHalo1;
