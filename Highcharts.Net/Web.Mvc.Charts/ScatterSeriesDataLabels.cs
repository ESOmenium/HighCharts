...
namespace Highsoft.Web.Mvc.Charts
{
	...
	{
		public ScatterSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private ScatterSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public ScatterSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private ScatterSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public ScatterSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private ScatterSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			ScatterSeriesDataLabelsAlign scatterSeriesDataLabelsAlign = (ScatterSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (ScatterSeriesDataLabelsAlign)num;
			this.Align = scatterSeriesDataLabelsAlign;
			...
			int num1 = 0;
			ScatterSeriesDataLabelsOverflow scatterSeriesDataLabelsOverflow = (ScatterSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (ScatterSeriesDataLabelsOverflow)num1;
			this.Overflow = scatterSeriesDataLabelsOverflow;
			...
			int num2 = 0;
			ScatterSeriesDataLabelsVerticalAlign scatterSeriesDataLabelsVerticalAlign = (ScatterSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (ScatterSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign = scatterSeriesDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				ScatterSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("ScatterSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				ScatterSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				ScatterSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
