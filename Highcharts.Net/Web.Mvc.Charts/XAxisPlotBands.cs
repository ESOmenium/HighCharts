...
namespace Highsoft.Web.Mvc.Charts
{
	public class XAxisPlotBands : BaseObject
	{
		...
		public XAxisPlotBandsLabel Label
		{
			get;
			set;
		}

		private XAxisPlotBandsLabel Label_DefaultValue
		{
			get;
			set;
		}
		...
		public XAxisPlotBands()
		{
			...
			this.Id = str1;
			XAxisPlotBandsLabel xAxisPlotBandsLabel = new XAxisPlotBandsLabel();
			XAxisPlotBandsLabel xAxisPlotBandsLabel1 = xAxisPlotBandsLabel;
			this.Label_DefaultValue = xAxisPlotBandsLabel;
			this.Label = xAxisPlotBandsLabel1;
			nullable = null;
