...
namespace Highsoft.Web.Mvc.Charts
{
	public class PyramidSeriesData : BaseObject
	{
		...
		public PyramidSeriesDataEvents Events
		{
			get;
			set;
		}

		private PyramidSeriesDataEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public PyramidSeriesData()
		{
			...
			this.Drilldown = str;
			PyramidSeriesDataEvents pyramidSeriesDataEvent = new PyramidSeriesDataEvents();
			PyramidSeriesDataEvents pyramidSeriesDataEvent1 = pyramidSeriesDataEvent;
			this.Events_DefaultValue = pyramidSeriesDataEvent;
			this.Events = pyramidSeriesDataEvent1;
			object obj3 = null;
			str = (string)obj3;
