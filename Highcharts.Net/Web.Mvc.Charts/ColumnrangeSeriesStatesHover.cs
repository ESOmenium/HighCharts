...
namespace Highsoft.Web.Mvc.Charts
{
	public class ColumnrangeSeriesStatesHover : BaseObject
	{
		...
		public ColumnrangeSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private ColumnrangeSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnrangeSeriesStatesHover()
		{
			...
			ColumnrangeSeriesStatesHoverHalo columnrangeSeriesStatesHoverHalo = new ColumnrangeSeriesStatesHoverHalo();
			ColumnrangeSeriesStatesHoverHalo columnrangeSeriesStatesHoverHalo1 = columnrangeSeriesStatesHoverHalo;
			this.Halo_DefaultValue = columnrangeSeriesStatesHoverHalo;
			this.Halo = columnrangeSeriesStatesHoverHalo1;
