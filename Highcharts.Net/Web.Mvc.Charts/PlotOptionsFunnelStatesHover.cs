...
{
	public class PlotOptionsFunnelStatesHover : BaseObject
	{
		...
		public PlotOptionsFunnelStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsFunnelStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsFunnelStatesHover()
		{
			...
			PlotOptionsFunnelStatesHoverHalo plotOptionsFunnelStatesHoverHalo = new PlotOptionsFunnelStatesHoverHalo();
			PlotOptionsFunnelStatesHoverHalo plotOptionsFunnelStatesHoverHalo1 = plotOptionsFunnelStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsFunnelStatesHoverHalo;
			this.Halo = plotOptionsFunnelStatesHoverHalo1;
