...
namespace Highsoft.Web.Mvc.Charts
{
	public class HeatmapSeries : Series
	{
		...
		public HeatmapSeriesCursor Cursor
		{
			get;
			set;
		}

		private HeatmapSeriesCursor Cursor_DefaultValue
		{
			get;
			set;
		}

		public new List<HeatmapSeriesData> Data
		{
			get;
			set;
		}

		private List<HeatmapSeriesData> Data_DefaultValue
		{
			get;
			set;
		}

		public HeatmapSeriesDataLabels DataLabels
		{
			get;
			set;
		}

		private HeatmapSeriesDataLabels DataLabels_DefaultValue
		{
			get;
			set;
		}
		...
		public HeatmapSeriesEvents Events
		{
			get;
			set;
		}

		private HeatmapSeriesEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public HeatmapSeriesPoint Point
		{
			get;
			set;
		}

		private HeatmapSeriesPoint Point_DefaultValue
		{
			get;
			set;
		}
		...
		public HeatmapSeriesStates States
		{
			get;
			set;
		}

		private HeatmapSeriesStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public HeatmapSeriesTooltip Tooltip
		{
			get;
			set;
		}

		private HeatmapSeriesTooltip Tooltip_DefaultValue
		{
			get;
			set;
		}
		...
		public new HeatmapSeriesType Type
		{
			get;
			set;
		}

		private HeatmapSeriesType Type_DefaultValue
		{
			get;
			set;
		}
		...
		public HeatmapSeriesZones Zones
		{
			get;
			set;
		}

		private HeatmapSeriesZones Zones_DefaultValue
		{
			get;
			set;
		}
