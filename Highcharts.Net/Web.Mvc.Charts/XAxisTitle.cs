...
namespace Highsoft.Web.Mvc.Charts
{
	...
	{
		public XAxisTitleAlign Align
		{
			get;
			set;
		}

		private XAxisTitleAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			XAxisTitleAlign xAxisTitleAlign = (XAxisTitleAlign)num;
			this.Align_DefaultValue = (XAxisTitleAlign)num;
			this.Align = xAxisTitleAlign;
			object obj = null;
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				XAxisTitleAlign align = this.Align;
