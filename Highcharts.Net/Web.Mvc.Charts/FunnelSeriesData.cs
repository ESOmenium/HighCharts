...
namespace Highsoft.Web.Mvc.Charts
{
	public class FunnelSeriesData : BaseObject
	{
		...
		public FunnelSeriesDataEvents Events
		{
			get;
			set;
		}

		private FunnelSeriesDataEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public FunnelSeriesData()
		{
			...
			this.Drilldown = str;
			FunnelSeriesDataEvents funnelSeriesDataEvent = new FunnelSeriesDataEvents();
			FunnelSeriesDataEvents funnelSeriesDataEvent1 = funnelSeriesDataEvent;
			this.Events_DefaultValue = funnelSeriesDataEvent;
			this.Events = funnelSeriesDataEvent1;
			object obj3 = null;
			str = (string)obj3;
