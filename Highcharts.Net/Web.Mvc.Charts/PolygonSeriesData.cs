...
namespace Highsoft.Web.Mvc.Charts
{
	public class PolygonSeriesData : BaseObject
	{
		...
		public PolygonSeriesDataEvents Events
		{
			get;
			set;
		}

		private PolygonSeriesDataEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public PolygonSeriesDataMarker Marker
		{
			get;
			set;
		}

		private PolygonSeriesDataMarker Marker_DefaultValue
		{
			get;
			set;
		}
		...
		public PolygonSeriesData()
		{
			...
			this.Drilldown = str;
			PolygonSeriesDataEvents polygonSeriesDataEvent = new PolygonSeriesDataEvents();
			PolygonSeriesDataEvents polygonSeriesDataEvent1 = polygonSeriesDataEvent;
			this.Events_DefaultValue = polygonSeriesDataEvent;
			this.Events = polygonSeriesDataEvent1;
			object obj3 = null;
			str = (string)obj3;
			...
			PolygonSeriesDataMarker polygonSeriesDataMarker = new PolygonSeriesDataMarker();
			PolygonSeriesDataMarker polygonSeriesDataMarker1 = polygonSeriesDataMarker;
			this.Marker_DefaultValue = polygonSeriesDataMarker;
			this.Marker = polygonSeriesDataMarker1;
			object obj4 = null;
			str = (string)obj4;
