...
{
	public class PlotOptionsErrorbarStatesHover : BaseObject
	{
		...
		public PlotOptionsErrorbarStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsErrorbarStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsErrorbarStatesHover()
		{
			...
			PlotOptionsErrorbarStatesHoverHalo plotOptionsErrorbarStatesHoverHalo = new PlotOptionsErrorbarStatesHoverHalo();
			PlotOptionsErrorbarStatesHoverHalo plotOptionsErrorbarStatesHoverHalo1 = plotOptionsErrorbarStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsErrorbarStatesHoverHalo;
			this.Halo = plotOptionsErrorbarStatesHoverHalo1;
