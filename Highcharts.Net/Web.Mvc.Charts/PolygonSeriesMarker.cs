...
{
	public class PolygonSeriesMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public PolygonSeriesMarkerStates States
		{
			get;
			set;
		}

		private PolygonSeriesMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public PolygonSeriesMarker()
		{
			...
			PolygonSeriesMarkerStates polygonSeriesMarkerState = new PolygonSeriesMarkerStates();
			PolygonSeriesMarkerStates polygonSeriesMarkerState1 = polygonSeriesMarkerState;
			this.States_DefaultValue = polygonSeriesMarkerState;
			this.States = polygonSeriesMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
