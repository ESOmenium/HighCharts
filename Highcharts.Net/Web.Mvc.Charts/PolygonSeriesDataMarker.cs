...
{
	public class PolygonSeriesDataMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public PolygonSeriesDataMarkerStates States
		{
			get;
			set;
		}

		private PolygonSeriesDataMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public PolygonSeriesDataMarker()
		{
			bool? nullable = null;
			...
			PolygonSeriesDataMarkerStates polygonSeriesDataMarkerState = new PolygonSeriesDataMarkerStates();
			PolygonSeriesDataMarkerStates polygonSeriesDataMarkerState1 = polygonSeriesDataMarkerState;
			this.States_DefaultValue = polygonSeriesDataMarkerState;
			this.States = polygonSeriesDataMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
