...
{
	public class PlotOptionsAreasplineDataLabels : BaseObject
	{
		public PlotOptionsAreasplineDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsAreasplineDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsAreasplineDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsAreasplineDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsAreasplineDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsAreasplineDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsAreasplineDataLabelsAlign plotOptionsAreasplineDataLabelsAlign = (PlotOptionsAreasplineDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsAreasplineDataLabelsAlign)num;
			this.Align = plotOptionsAreasplineDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsAreasplineDataLabelsOverflow plotOptionsAreasplineDataLabelsOverflow = (PlotOptionsAreasplineDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsAreasplineDataLabelsOverflow)num1;
			this.Overflow = plotOptionsAreasplineDataLabelsOverflow;
			...
			int num2 = 0;
			PlotOptionsAreasplineDataLabelsVerticalAlign plotOptionsAreasplineDataLabelsVerticalAlign = (PlotOptionsAreasplineDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PlotOptionsAreasplineDataLabelsVerticalAlign)num2;
			this.VerticalAlign = plotOptionsAreasplineDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsAreasplineDataLabelsAlign align = this.Align;
			...
			{
				PlotOptionsAreasplineDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsAreasplineDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
