...
{
	public class PlotOptionsFunnelEvents : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.AfterAnimate != this.AfterAnimate_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsFunnelEventsAfterAnimate.afterAnimate", this.AfterAnimate);
			}
			if (this.CheckboxClick != this.CheckboxClick_DefaultValue)
			{
				hashtables.Add("checkboxClick", this.CheckboxClick);
				Highcharts.AddFunction("PlotOptionsFunnelEventsCheckboxClick.checkboxClick", this.CheckboxClick);
			}
			if (this.Click != this.Click_DefaultValue)
			{
				hashtables.Add("click", this.Click);
				Highcharts.AddFunction("PlotOptionsFunnelEventsClick.click", this.Click);
			}
			if (this.Hide != this.Hide_DefaultValue)
			{
				hashtables.Add("hide", this.Hide);
				Highcharts.AddFunction("PlotOptionsFunnelEventsHide.hide", this.Hide);
			}
			if (this.LegendItemClick != this.LegendItemClick_DefaultValue)
			{
				hashtables.Add("legendItemClick", this.LegendItemClick);
				Highcharts.AddFunction("PlotOptionsFunnelEventsLegendItemClick.legendItemClick", this.LegendItemClick);
			}
			if (this.MouseOut != this.MouseOut_DefaultValue)
			{
				hashtables.Add("mouseOut", this.MouseOut);
				Highcharts.AddFunction("PlotOptionsFunnelEventsMouseOut.mouseOut", this.MouseOut);
			}
			if (this.MouseOver != this.MouseOver_DefaultValue)
			{
				hashtables.Add("mouseOver", this.MouseOver);
				Highcharts.AddFunction("PlotOptionsFunnelEventsMouseOver.mouseOver", this.MouseOver);
			}
			if (this.Show != this.Show_DefaultValue)
			{
				hashtables.Add("show", this.Show);
				Highcharts.AddFunction("PlotOptionsFunnelEventsShow.show", this.Show);
			}
			return hashtables;
		}
