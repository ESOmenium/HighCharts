...
{
	public class PlotOptionsColumnrangeStatesHover : BaseObject
	{
		...
		public PlotOptionsColumnrangeStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsColumnrangeStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumnrangeStatesHover()
		{
			...
			PlotOptionsColumnrangeStatesHoverHalo plotOptionsColumnrangeStatesHoverHalo = new PlotOptionsColumnrangeStatesHoverHalo();
			PlotOptionsColumnrangeStatesHoverHalo plotOptionsColumnrangeStatesHoverHalo1 = plotOptionsColumnrangeStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsColumnrangeStatesHoverHalo;
			this.Halo = plotOptionsColumnrangeStatesHoverHalo1;
