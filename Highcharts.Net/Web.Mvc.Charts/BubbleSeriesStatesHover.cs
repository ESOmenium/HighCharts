...
{
	public class BubbleSeriesStatesHover : BaseObject
	{
		...
		public BubbleSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private BubbleSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public BubbleSeriesStatesHover()
		{
			...
			BubbleSeriesStatesHoverHalo bubbleSeriesStatesHoverHalo = new BubbleSeriesStatesHoverHalo();
			BubbleSeriesStatesHoverHalo bubbleSeriesStatesHoverHalo1 = bubbleSeriesStatesHoverHalo;
			this.Halo_DefaultValue = bubbleSeriesStatesHoverHalo;
			this.Halo = bubbleSeriesStatesHoverHalo1;
