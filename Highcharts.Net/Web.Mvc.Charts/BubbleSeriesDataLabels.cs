...
{
	public class BubbleSeriesDataLabels : BaseObject
	{
		public BubbleSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private BubbleSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public BubbleSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private BubbleSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public BubbleSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private BubbleSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			BubbleSeriesDataLabelsAlign bubbleSeriesDataLabelsAlign = (BubbleSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (BubbleSeriesDataLabelsAlign)num;
			this.Align = bubbleSeriesDataLabelsAlign;
			...
			int num1 = 0;
			BubbleSeriesDataLabelsOverflow bubbleSeriesDataLabelsOverflow = (BubbleSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (BubbleSeriesDataLabelsOverflow)num1;
			this.Overflow = bubbleSeriesDataLabelsOverflow;
			...
			int num2 = 0;
			BubbleSeriesDataLabelsVerticalAlign bubbleSeriesDataLabelsVerticalAlign = (BubbleSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (BubbleSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign = bubbleSeriesDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				BubbleSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("BubbleSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				BubbleSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				BubbleSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
