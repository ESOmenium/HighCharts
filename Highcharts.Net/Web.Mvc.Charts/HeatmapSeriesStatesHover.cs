...
{
	public class HeatmapSeriesStatesHover : BaseObject
	{
		...
		public HeatmapSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private HeatmapSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public HeatmapSeriesStatesHover()
		{
			...
			HeatmapSeriesStatesHoverHalo heatmapSeriesStatesHoverHalo = new HeatmapSeriesStatesHoverHalo();
			HeatmapSeriesStatesHoverHalo heatmapSeriesStatesHoverHalo1 = heatmapSeriesStatesHoverHalo;
			this.Halo_DefaultValue = heatmapSeriesStatesHoverHalo;
			this.Halo = heatmapSeriesStatesHoverHalo1;
