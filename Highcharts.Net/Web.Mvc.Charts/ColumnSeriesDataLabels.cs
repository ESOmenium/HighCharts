...
{
	public class ColumnSeriesDataLabels : BaseObject
	{
		public ColumnSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private ColumnSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private ColumnSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private ColumnSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			ColumnSeriesDataLabelsAlign columnSeriesDataLabelsAlign = (ColumnSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (ColumnSeriesDataLabelsAlign)num;
			this.Align = columnSeriesDataLabelsAlign;
			...
			int num1 = 0;
			ColumnSeriesDataLabelsOverflow columnSeriesDataLabelsOverflow = (ColumnSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (ColumnSeriesDataLabelsOverflow)num1;
			this.Overflow = columnSeriesDataLabelsOverflow;
			...
			int num2 = 0;
			ColumnSeriesDataLabelsVerticalAlign columnSeriesDataLabelsVerticalAlign = (ColumnSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (ColumnSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign = columnSeriesDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				ColumnSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("ColumnSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				ColumnSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				ColumnSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
