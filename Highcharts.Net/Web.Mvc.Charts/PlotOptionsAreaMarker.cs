...
{
	public class PlotOptionsAreaMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public PlotOptionsAreaMarkerStates States
		{
			get;
			set;
		}

		private PlotOptionsAreaMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsAreaMarker()
		{
			...
			PlotOptionsAreaMarkerStates plotOptionsAreaMarkerState = new PlotOptionsAreaMarkerStates();
			PlotOptionsAreaMarkerStates plotOptionsAreaMarkerState1 = plotOptionsAreaMarkerState;
			this.States_DefaultValue = plotOptionsAreaMarkerState;
			this.States = plotOptionsAreaMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
