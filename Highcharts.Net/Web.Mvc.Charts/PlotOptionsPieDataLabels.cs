...
{
	public class PlotOptionsPieDataLabels : BaseObject
	{
		...
		public PlotOptionsPieDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsPieDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsPieDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsPieDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsPieDataLabels()
		{
			...
			int num = 0;
			PlotOptionsPieDataLabelsOverflow plotOptionsPieDataLabelsOverflow = (PlotOptionsPieDataLabelsOverflow)num;
			this.Overflow_DefaultValue = (PlotOptionsPieDataLabelsOverflow)num;
			this.Overflow = plotOptionsPieDataLabelsOverflow;
			nullable = new double?((double)5);
			...
			int num1 = 0;
			PlotOptionsPieDataLabelsVerticalAlign plotOptionsPieDataLabelsVerticalAlign = (PlotOptionsPieDataLabelsVerticalAlign)num1;
			this.VerticalAlign_DefaultValue = (PlotOptionsPieDataLabelsVerticalAlign)num1;
			this.VerticalAlign = plotOptionsPieDataLabelsVerticalAlign;
			nullable = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsPieDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsPieDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsPieDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
