...
{
	public class AreasplineSeriesTooltip : BaseObject
	{
		...
		public AreasplineSeriesTooltip()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("AreasplineSeriesTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
