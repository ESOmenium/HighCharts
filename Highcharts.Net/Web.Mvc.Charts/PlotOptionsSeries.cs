...
namespace Highsoft.Web.Mvc.Charts
{
	public class PlotOptionsSeries : BaseObject
	{
		...
		public PlotOptionsSeriesCursor Cursor
		{
			get;
			set;
		}

		private PlotOptionsSeriesCursor Cursor_DefaultValue
		{
			get;
			set;
		}

		public PlotOptionsSeriesDashStyle DashStyle
		{
			get;
			set;
		}

		private PlotOptionsSeriesDashStyle DashStyle_DefaultValue
		{
			get;
			set;
		}

		public PlotOptionsSeriesDataLabels DataLabels
		{
			get;
			set;
		}

		private PlotOptionsSeriesDataLabels DataLabels_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesEvents Events
		{
			get;
			set;
		}

		private PlotOptionsSeriesEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesLinecap Linecap
		{
			get;
			set;
		}

		private PlotOptionsSeriesLinecap Linecap_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesMarker Marker
		{
			get;
			set;
		}

		private PlotOptionsSeriesMarker Marker_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesPoint Point
		{
			get;
			set;
		}

		private PlotOptionsSeriesPoint Point_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesPointIntervalUnit PointIntervalUnit
		{
			get;
			set;
		}

		private PlotOptionsSeriesPointIntervalUnit PointIntervalUnit_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesStacking Stacking
		{
			get;
			set;
		}

		private PlotOptionsSeriesStacking Stacking_DefaultValue
		{
			get;
			set;
		}

		public PlotOptionsSeriesStates States
		{
			get;
			set;
		}

		private PlotOptionsSeriesStates States_DefaultValue
		{
			get;
			set;
		}

		public PlotOptionsSeriesStep Step
		{
			get;
			set;
		}

		private PlotOptionsSeriesStep Step_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesTooltip Tooltip
		{
			get;
			set;
		}

		private PlotOptionsSeriesTooltip Tooltip_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesZones Zones
		{
			get;
			set;
		}

		private PlotOptionsSeriesZones Zones_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeries()
		{
			...
			int num = 0;
			PlotOptionsSeriesCursor plotOptionsSeriesCursor = (PlotOptionsSeriesCursor)num;
			this.Cursor_DefaultValue = (PlotOptionsSeriesCursor)num;
			this.Cursor = plotOptionsSeriesCursor;
			int num1 = 0;
			PlotOptionsSeriesDashStyle plotOptionsSeriesDashStyle = (PlotOptionsSeriesDashStyle)num1;
			this.DashStyle_DefaultValue = (PlotOptionsSeriesDashStyle)num1;
			this.DashStyle = plotOptionsSeriesDashStyle;
			PlotOptionsSeriesDataLabels plotOptionsSeriesDataLabel = new PlotOptionsSeriesDataLabels();
			PlotOptionsSeriesDataLabels plotOptionsSeriesDataLabel1 = plotOptionsSeriesDataLabel;
			this.DataLabels_DefaultValue = plotOptionsSeriesDataLabel;
			this.DataLabels = plotOptionsSeriesDataLabel1;
			...
			PlotOptionsSeriesEvents plotOptionsSeriesEvent = new PlotOptionsSeriesEvents();
			PlotOptionsSeriesEvents plotOptionsSeriesEvent1 = plotOptionsSeriesEvent;
			this.Events_DefaultValue = plotOptionsSeriesEvent;
			this.Events = plotOptionsSeriesEvent1;
			nullable = new bool?(false);
			...
			int num2 = 0;
			PlotOptionsSeriesLinecap plotOptionsSeriesLinecap = (PlotOptionsSeriesLinecap)num2;
			this.Linecap_DefaultValue = (PlotOptionsSeriesLinecap)num2;
			this.Linecap = plotOptionsSeriesLinecap;
			string str3 = "";
			str1 = str3;
			this.LinkedTo_DefaultValue = str3;
			this.LinkedTo = str1;
			PlotOptionsSeriesMarker plotOptionsSeriesMarker = new PlotOptionsSeriesMarker();
			PlotOptionsSeriesMarker plotOptionsSeriesMarker1 = plotOptionsSeriesMarker;
			this.Marker_DefaultValue = plotOptionsSeriesMarker;
			this.Marker = plotOptionsSeriesMarker1;
			string str4 = "null";
			str1 = str4;
			this.NegativeColor_DefaultValue = str4;
			this.NegativeColor = str1;
			PlotOptionsSeriesPoint plotOptionsSeriesPoint = new PlotOptionsSeriesPoint();
			PlotOptionsSeriesPoint plotOptionsSeriesPoint1 = plotOptionsSeriesPoint;
			this.Point_DefaultValue = plotOptionsSeriesPoint;
			this.Point = plotOptionsSeriesPoint1;
			nullable1 = new double?((double)1);
			this.PointInterval_DefaultValue = nullable1;
			this.PointInterval = nullable1;
			int num3 = 0;
			PlotOptionsSeriesPointIntervalUnit plotOptionsSeriesPointIntervalUnit = (PlotOptionsSeriesPointIntervalUnit)num3;
			this.PointIntervalUnit_DefaultValue = (PlotOptionsSeriesPointIntervalUnit)num3;
			this.PointIntervalUnit = plotOptionsSeriesPointIntervalUnit;
			...
			int num4 = 0;
			PlotOptionsSeriesStacking plotOptionsSeriesStacking = (PlotOptionsSeriesStacking)num4;
			this.Stacking_DefaultValue = (PlotOptionsSeriesStacking)num4;
			this.Stacking = plotOptionsSeriesStacking;
			PlotOptionsSeriesStates plotOptionsSeriesState = new PlotOptionsSeriesStates();
			PlotOptionsSeriesStates plotOptionsSeriesState1 = plotOptionsSeriesState;
			this.States_DefaultValue = plotOptionsSeriesState;
			this.States = plotOptionsSeriesState1;
			int num5 = 0;
			PlotOptionsSeriesStep plotOptionsSeriesStep = (PlotOptionsSeriesStep)num5;
			this.Step_DefaultValue = (PlotOptionsSeriesStep)num5;
			this.Step = plotOptionsSeriesStep;
			nullable = new bool?(true);
			...
			PlotOptionsSeriesTooltip plotOptionsSeriesTooltip = new PlotOptionsSeriesTooltip();
			PlotOptionsSeriesTooltip plotOptionsSeriesTooltip1 = plotOptionsSeriesTooltip;
			this.Tooltip_DefaultValue = plotOptionsSeriesTooltip;
			this.Tooltip = plotOptionsSeriesTooltip1;
			...
			this.ZoneAxis = str1;
			PlotOptionsSeriesZones plotOptionsSeriesZone = new PlotOptionsSeriesZones();
			PlotOptionsSeriesZones plotOptionsSeriesZone1 = plotOptionsSeriesZone;
			this.Zones_DefaultValue = plotOptionsSeriesZone;
			this.Zones = plotOptionsSeriesZone1;
		}
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsSeriesCursor cursor = this.Cursor;
				hashtables.Add("cursor", Highcharts.FirstCharacterToLower(cursor.ToString()));
			}
			if (this.DashStyle != this.DashStyle_DefaultValue)
			{
				PlotOptionsSeriesDashStyle dashStyle = this.DashStyle;
			...
			{
				PlotOptionsSeriesLinecap linecap = this.Linecap;
			...
			{
				PlotOptionsSeriesPointIntervalUnit pointIntervalUnit = this.PointIntervalUnit;
			...
			{
				PlotOptionsSeriesStacking stacking = this.Stacking;
			...
			{
				PlotOptionsSeriesStep step = this.Step;
