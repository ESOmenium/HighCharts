...
namespace Highsoft.Web.Mvc.Charts
{
	public class PlotOptionsPyramidDataLabels : BaseObject
	{
		...
		public PlotOptionsPyramidDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsPyramidDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsPyramidDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsPyramidDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsPyramidDataLabels()
		{
			...
			int num = 0;
			PlotOptionsPyramidDataLabelsOverflow plotOptionsPyramidDataLabelsOverflow = (PlotOptionsPyramidDataLabelsOverflow)num;
			this.Overflow_DefaultValue = (PlotOptionsPyramidDataLabelsOverflow)num;
			this.Overflow = plotOptionsPyramidDataLabelsOverflow;
			nullable = new double?((double)5);
			...
			int num1 = 0;
			PlotOptionsPyramidDataLabelsVerticalAlign plotOptionsPyramidDataLabelsVerticalAlign = (PlotOptionsPyramidDataLabelsVerticalAlign)num1;
			this.VerticalAlign_DefaultValue = (PlotOptionsPyramidDataLabelsVerticalAlign)num1;
			this.VerticalAlign = plotOptionsPyramidDataLabelsVerticalAlign;
			nullable = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsPyramidDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsPyramidDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
