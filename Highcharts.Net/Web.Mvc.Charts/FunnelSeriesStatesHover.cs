...
{
	public class FunnelSeriesStatesHover : BaseObject
	{
		...
		public FunnelSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private FunnelSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public FunnelSeriesStatesHover()
		{
			...
			FunnelSeriesStatesHoverHalo funnelSeriesStatesHoverHalo = new FunnelSeriesStatesHoverHalo();
			FunnelSeriesStatesHoverHalo funnelSeriesStatesHoverHalo1 = funnelSeriesStatesHoverHalo;
			this.Halo_DefaultValue = funnelSeriesStatesHoverHalo;
			this.Halo = funnelSeriesStatesHoverHalo1;
