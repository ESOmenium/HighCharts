...
{
	public class PlotOptionsSolidgaugeDataLabels : BaseObject
	{
		public PlotOptionsSolidgaugeDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsSolidgaugeDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSolidgaugeDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsSolidgaugeDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsSolidgaugeDataLabelsAlign plotOptionsSolidgaugeDataLabelsAlign = (PlotOptionsSolidgaugeDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsSolidgaugeDataLabelsAlign)num;
			this.Align = plotOptionsSolidgaugeDataLabelsAlign;
			...
			double? nullable1 = new double?((double)3);
			...
			object obj1 = null;
			str = (string)obj1;
			this.ClassName_DefaultValue = (string)obj1;
			this.ClassName = str;
			object obj2 = null;
			str = (string)obj2;
			...
			int num1 = 0;
			PlotOptionsSolidgaugeDataLabelsOverflow plotOptionsSolidgaugeDataLabelsOverflow = (PlotOptionsSolidgaugeDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsSolidgaugeDataLabelsOverflow)num1;
			this.Overflow = plotOptionsSolidgaugeDataLabelsOverflow;
			...
			string str5 = "top";
			str = str5;
			this.VerticalAlign_DefaultValue = str5;
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsSolidgaugeDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsSolidgaugeDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsSolidgaugeDataLabelsOverflow overflow = this.Overflow;
