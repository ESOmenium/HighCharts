...
{
	public class PieSeriesStatesHover : BaseObject
	{
		...
		public PieSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PieSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PieSeriesStatesHover()
		{
			...
			PieSeriesStatesHoverHalo pieSeriesStatesHoverHalo = new PieSeriesStatesHoverHalo();
			PieSeriesStatesHoverHalo pieSeriesStatesHoverHalo1 = pieSeriesStatesHoverHalo;
			this.Halo_DefaultValue = pieSeriesStatesHoverHalo;
			this.Halo = pieSeriesStatesHoverHalo1;
