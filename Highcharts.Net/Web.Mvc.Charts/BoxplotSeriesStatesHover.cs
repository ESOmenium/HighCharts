...
{
	public class BoxplotSeriesStatesHover : BaseObject
	{
		...
		public BoxplotSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private BoxplotSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public BoxplotSeriesStatesHover()
		{
			...
			BoxplotSeriesStatesHoverHalo boxplotSeriesStatesHoverHalo = new BoxplotSeriesStatesHoverHalo();
			BoxplotSeriesStatesHoverHalo boxplotSeriesStatesHoverHalo1 = boxplotSeriesStatesHoverHalo;
			this.Halo_DefaultValue = boxplotSeriesStatesHoverHalo;
			this.Halo = boxplotSeriesStatesHoverHalo1;
