...
{
	public class AreaSeriesDataLabels : BaseObject
	{
		public AreaSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private AreaSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private AreaSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private AreaSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			AreaSeriesDataLabelsAlign areaSeriesDataLabelsAlign = (AreaSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (AreaSeriesDataLabelsAlign)num;
			this.Align = areaSeriesDataLabelsAlign;
			...
			int num1 = 0;
			AreaSeriesDataLabelsOverflow areaSeriesDataLabelsOverflow = (AreaSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (AreaSeriesDataLabelsOverflow)num1;
			this.Overflow = areaSeriesDataLabelsOverflow;
			...
			int num2 = 0;
			AreaSeriesDataLabelsVerticalAlign areaSeriesDataLabelsVerticalAlign = (AreaSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (AreaSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign = areaSeriesDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				AreaSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("AreaSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				AreaSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				AreaSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
