...
{
	public class PlotOptionsSeriesStatesHover : BaseObject
	{
		...
		public PlotOptionsSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSeriesStatesHover()
		{
			...
			PlotOptionsSeriesStatesHoverHalo plotOptionsSeriesStatesHoverHalo = new PlotOptionsSeriesStatesHoverHalo();
			PlotOptionsSeriesStatesHoverHalo plotOptionsSeriesStatesHoverHalo1 = plotOptionsSeriesStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsSeriesStatesHoverHalo;
			this.Halo = plotOptionsSeriesStatesHoverHalo1;
