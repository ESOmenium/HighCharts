...
{
	public class TreemapSeriesDataLabels : BaseObject
	{
		public TreemapSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private TreemapSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public TreemapSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private TreemapSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			TreemapSeriesDataLabelsAlign treemapSeriesDataLabelsAlign = (TreemapSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (TreemapSeriesDataLabelsAlign)num;
			this.Align = treemapSeriesDataLabelsAlign;
			...
			int num1 = 0;
			TreemapSeriesDataLabelsOverflow treemapSeriesDataLabelsOverflow = (TreemapSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (TreemapSeriesDataLabelsOverflow)num1;
			this.Overflow = treemapSeriesDataLabelsOverflow;
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				TreemapSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("TreemapSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				TreemapSeriesDataLabelsOverflow overflow = this.Overflow;
