...
namespace Highsoft.Web.Mvc.Charts
{
	public class PlotOptionsScatter : BaseObject
	{
		...
		public PlotOptionsScatterCursor Cursor
		{
			get;
			set;
		}

		private PlotOptionsScatterCursor Cursor_DefaultValue
		{
			get;
			set;
		}

		public PlotOptionsScatterDashStyle DashStyle
		{
			get;
			set;
		}

		private PlotOptionsScatterDashStyle DashStyle_DefaultValue
		{
			get;
			set;
		}

		public PlotOptionsScatterDataLabels DataLabels
		{
			get;
			set;
		}

		private PlotOptionsScatterDataLabels DataLabels_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsScatterEvents Events
		{
			get;
			set;
		}

		private PlotOptionsScatterEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsScatterMarker Marker
		{
			get;
			set;
		}

		private PlotOptionsScatterMarker Marker_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsScatterPoint Point
		{
			get;
			set;
		}

		private PlotOptionsScatterPoint Point_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsScatterPointIntervalUnit PointIntervalUnit
		{
			get;
			set;
		}

		private PlotOptionsScatterPointIntervalUnit PointIntervalUnit_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsScatterStates States
		{
			get;
			set;
		}

		private PlotOptionsScatterStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsScatterZones Zones
		{
			get;
			set;
		}

		private PlotOptionsScatterZones Zones_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsScatter()
		{
			...
			int num = 0;
			PlotOptionsScatterCursor plotOptionsScatterCursor = (PlotOptionsScatterCursor)num;
			this.Cursor_DefaultValue = (PlotOptionsScatterCursor)num;
			this.Cursor = plotOptionsScatterCursor;
			int num1 = 0;
			PlotOptionsScatterDashStyle plotOptionsScatterDashStyle = (PlotOptionsScatterDashStyle)num1;
			this.DashStyle_DefaultValue = (PlotOptionsScatterDashStyle)num1;
			this.DashStyle = plotOptionsScatterDashStyle;
			PlotOptionsScatterDataLabels plotOptionsScatterDataLabel = new PlotOptionsScatterDataLabels();
			PlotOptionsScatterDataLabels plotOptionsScatterDataLabel1 = plotOptionsScatterDataLabel;
			this.DataLabels_DefaultValue = plotOptionsScatterDataLabel;
			this.DataLabels = plotOptionsScatterDataLabel1;
			...
			PlotOptionsScatterEvents plotOptionsScatterEvent = new PlotOptionsScatterEvents();
			PlotOptionsScatterEvents plotOptionsScatterEvent1 = plotOptionsScatterEvent;
			this.Events_DefaultValue = plotOptionsScatterEvent;
			this.Events = plotOptionsScatterEvent1;
			...
			this.LinkedTo = str1;
			PlotOptionsScatterMarker plotOptionsScatterMarker = new PlotOptionsScatterMarker();
			PlotOptionsScatterMarker plotOptionsScatterMarker1 = plotOptionsScatterMarker;
			this.Marker_DefaultValue = plotOptionsScatterMarker;
			this.Marker = plotOptionsScatterMarker1;
			string str4 = "null";
			str1 = str4;
			this.NegativeColor_DefaultValue = str4;
			this.NegativeColor = str1;
			PlotOptionsScatterPoint plotOptionsScatterPoint = new PlotOptionsScatterPoint();
			PlotOptionsScatterPoint plotOptionsScatterPoint1 = plotOptionsScatterPoint;
			this.Point_DefaultValue = plotOptionsScatterPoint;
			this.Point = plotOptionsScatterPoint1;
			nullable1 = new double?((double)1);
			this.PointInterval_DefaultValue = nullable1;
			this.PointInterval = nullable1;
			int num2 = 0;
			PlotOptionsScatterPointIntervalUnit plotOptionsScatterPointIntervalUnit = (PlotOptionsScatterPointIntervalUnit)num2;
			this.PointIntervalUnit_DefaultValue = (PlotOptionsScatterPointIntervalUnit)num2;
			this.PointIntervalUnit = plotOptionsScatterPointIntervalUnit;
			nullable1 = new double?(0);
			...
			PlotOptionsScatterStates plotOptionsScatterState = new PlotOptionsScatterStates();
			PlotOptionsScatterStates plotOptionsScatterState1 = plotOptionsScatterState;
			this.States_DefaultValue = plotOptionsScatterState;
			this.States = plotOptionsScatterState1;
			nullable = new bool?(false);
			...
			this.ZoneAxis = str1;
			PlotOptionsScatterZones plotOptionsScatterZone = new PlotOptionsScatterZones();
			PlotOptionsScatterZones plotOptionsScatterZone1 = plotOptionsScatterZone;
			this.Zones_DefaultValue = plotOptionsScatterZone;
			this.Zones = plotOptionsScatterZone1;
		}
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsScatterCursor cursor = this.Cursor;
				hashtables.Add("cursor", Highcharts.FirstCharacterToLower(cursor.ToString()));
			}
			if (this.DashStyle != this.DashStyle_DefaultValue)
			{
				PlotOptionsScatterDashStyle dashStyle = this.DashStyle;
			...
			{
				PlotOptionsScatterPointIntervalUnit pointIntervalUnit = this.PointIntervalUnit;
