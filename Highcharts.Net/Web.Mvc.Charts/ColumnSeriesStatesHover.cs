...
namespace Highsoft.Web.Mvc.Charts
{
	public class ColumnSeriesStatesHover : BaseObject
	{
		...
		public ColumnSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private ColumnSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public ColumnSeriesStatesHover()
		{
			...
			ColumnSeriesStatesHoverHalo columnSeriesStatesHoverHalo = new ColumnSeriesStatesHoverHalo();
			ColumnSeriesStatesHoverHalo columnSeriesStatesHoverHalo1 = columnSeriesStatesHoverHalo;
			this.Halo_DefaultValue = columnSeriesStatesHoverHalo;
			this.Halo = columnSeriesStatesHoverHalo1;
