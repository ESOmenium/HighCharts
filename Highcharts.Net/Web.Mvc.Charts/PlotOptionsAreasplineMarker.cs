...
namespace Highsoft.Web.Mvc.Charts
{
	public class PlotOptionsAreasplineMarker : BaseObject
	{
		...
		public PlotOptionsAreasplineMarkerStates States
		{
			get;
			set;
		}

		private PlotOptionsAreasplineMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsAreasplineMarker()
		{
			...
			PlotOptionsAreasplineMarkerStates plotOptionsAreasplineMarkerState = new PlotOptionsAreasplineMarkerStates();
			PlotOptionsAreasplineMarkerStates plotOptionsAreasplineMarkerState1 = plotOptionsAreasplineMarkerState;
			this.States_DefaultValue = plotOptionsAreasplineMarkerState;
			this.States = plotOptionsAreasplineMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
