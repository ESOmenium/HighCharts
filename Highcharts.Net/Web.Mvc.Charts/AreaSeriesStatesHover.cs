...
{
	public class AreaSeriesStatesHover : BaseObject
	{
		...
		public AreaSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private AreaSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesStatesHover()
		{
			...
			AreaSeriesStatesHoverHalo areaSeriesStatesHoverHalo = new AreaSeriesStatesHoverHalo();
			AreaSeriesStatesHoverHalo areaSeriesStatesHoverHalo1 = areaSeriesStatesHoverHalo;
			this.Halo_DefaultValue = areaSeriesStatesHoverHalo;
			this.Halo = areaSeriesStatesHoverHalo1;
