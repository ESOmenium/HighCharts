...
{
	public class AreasplinerangeSeriesDataLabels : BaseObject
	{
		public AreasplinerangeSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private AreasplinerangeSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public AreasplinerangeSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private AreasplinerangeSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public AreasplinerangeSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private AreasplinerangeSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			AreasplinerangeSeriesDataLabelsAlign areasplinerangeSeriesDataLabelsAlign = (AreasplinerangeSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (AreasplinerangeSeriesDataLabelsAlign)num;
			this.Align = areasplinerangeSeriesDataLabelsAlign;
			...
			int num1 = 0;
			AreasplinerangeSeriesDataLabelsOverflow areasplinerangeSeriesDataLabelsOverflow = (AreasplinerangeSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (AreasplinerangeSeriesDataLabelsOverflow)num1;
			this.Overflow = areasplinerangeSeriesDataLabelsOverflow;
			...
			int num2 = 0;
			AreasplinerangeSeriesDataLabelsVerticalAlign areasplinerangeSeriesDataLabelsVerticalAlign = (AreasplinerangeSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (AreasplinerangeSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign = areasplinerangeSeriesDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				AreasplinerangeSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("AreasplinerangeSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				AreasplinerangeSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				AreasplinerangeSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
