...
{
	public class AreasplineSeriesStatesHover : BaseObject
	{
		...
		public AreasplineSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private AreasplineSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public AreasplineSeriesStatesHover()
		{
			...
			AreasplineSeriesStatesHoverHalo areasplineSeriesStatesHoverHalo = new AreasplineSeriesStatesHoverHalo();
			AreasplineSeriesStatesHoverHalo areasplineSeriesStatesHoverHalo1 = areasplineSeriesStatesHoverHalo;
			this.Halo_DefaultValue = areasplineSeriesStatesHoverHalo;
			this.Halo = areasplineSeriesStatesHoverHalo1;
