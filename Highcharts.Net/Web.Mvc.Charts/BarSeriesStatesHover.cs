...
{
	public class BarSeriesStatesHover : BaseObject
	{
		...
		public BarSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private BarSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public BarSeriesStatesHover()
		{
			...
			BarSeriesStatesHoverHalo barSeriesStatesHoverHalo = new BarSeriesStatesHoverHalo();
			BarSeriesStatesHoverHalo barSeriesStatesHoverHalo1 = barSeriesStatesHoverHalo;
			this.Halo_DefaultValue = barSeriesStatesHoverHalo;
			this.Halo = barSeriesStatesHoverHalo1;
