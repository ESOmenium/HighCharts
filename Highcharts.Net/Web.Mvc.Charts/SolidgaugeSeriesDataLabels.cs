...
namespace Highsoft.Web.Mvc.Charts
{
	...
	{
		public SolidgaugeSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private SolidgaugeSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public SolidgaugeSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private SolidgaugeSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			SolidgaugeSeriesDataLabelsAlign solidgaugeSeriesDataLabelsAlign = (SolidgaugeSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (SolidgaugeSeriesDataLabelsAlign)num;
			this.Align = solidgaugeSeriesDataLabelsAlign;
			...
			int num1 = 0;
			SolidgaugeSeriesDataLabelsOverflow solidgaugeSeriesDataLabelsOverflow = (SolidgaugeSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (SolidgaugeSeriesDataLabelsOverflow)num1;
			this.Overflow = solidgaugeSeriesDataLabelsOverflow;
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				SolidgaugeSeriesDataLabelsAlign align = this.Align;
			...
			{
				SolidgaugeSeriesDataLabelsOverflow overflow = this.Overflow;
