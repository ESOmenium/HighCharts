...
{
	public class BarSeriesDataLabels : BaseObject
	{
		public string Align
		{
			get;
		...
		public BarSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private BarSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public BarSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private BarSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		public BarSeriesDataLabels()
		{
			...
			int num = 0;
			BarSeriesDataLabelsOverflow barSeriesDataLabelsOverflow = (BarSeriesDataLabelsOverflow)num;
			this.Overflow_DefaultValue = (BarSeriesDataLabelsOverflow)num;
			this.Overflow = barSeriesDataLabelsOverflow;
			...
			int num1 = 0;
			BarSeriesDataLabelsVerticalAlign barSeriesDataLabelsVerticalAlign = (BarSeriesDataLabelsVerticalAlign)num1;
			this.VerticalAlign_DefaultValue = (BarSeriesDataLabelsVerticalAlign)num1;
			this.VerticalAlign = barSeriesDataLabelsVerticalAlign;
			nullable1 = new double?((double)5);
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("BarSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				BarSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				BarSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
