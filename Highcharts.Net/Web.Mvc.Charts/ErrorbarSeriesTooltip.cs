...
{
	public class ErrorbarSeriesTooltip : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("ErrorbarSeriesTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
