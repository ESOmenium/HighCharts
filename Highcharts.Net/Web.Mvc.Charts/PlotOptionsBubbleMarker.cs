...
namespace Highsoft.Web.Mvc.Charts
{
	public class PlotOptionsBubbleMarker : BaseObject
	{
		...
		public PlotOptionsBubbleMarkerStates States
		{
			get;
			set;
		}

		private PlotOptionsBubbleMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsBubbleMarker()
		{
			...
			PlotOptionsBubbleMarkerStates plotOptionsBubbleMarkerState = new PlotOptionsBubbleMarkerStates();
			PlotOptionsBubbleMarkerStates plotOptionsBubbleMarkerState1 = plotOptionsBubbleMarkerState;
			this.States_DefaultValue = plotOptionsBubbleMarkerState;
			this.States = plotOptionsBubbleMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
		...
		internal override Hashtable ToHashtable()
		{
			...
			height = this.Width;
			heightDefaultValue = this.Width_DefaultValue;
			if ((height.GetValueOrDefault() == heightDefaultValue.GetValueOrDefault() ? height.HasValue != heightDefaultValue.HasValue : true))
			{
