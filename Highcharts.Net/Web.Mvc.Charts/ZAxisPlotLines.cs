...
{
	public class ZAxisPlotLines : BaseObject
	{
		...
		public ZAxisPlotLinesDashStyle DashStyle
		{
			get;
			set;
		}

		private ZAxisPlotLinesDashStyle DashStyle_DefaultValue
		{
			get;
			set;
		}
		...
		public ZAxisPlotLinesLabel Label
		{
			get;
			set;
		}

		private ZAxisPlotLinesLabel Label_DefaultValue
		{
			get;
			set;
		}
