...
namespace Highsoft.Web.Mvc.Charts
{
	public class ZAxis : BaseObject
	{
		...
		public ZAxisCrosshair Crosshair
		{
			get;
			set;
		}

		private ZAxisCrosshair Crosshair_DefaultValue
		{
			get;
			set;
		}
		...
		public ZAxisEvents Events
		{
			get;
			set;
		}

		private ZAxisEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public ZAxisGridLineDashStyle GridLineDashStyle
		{
			get;
			set;
		}

		private ZAxisGridLineDashStyle GridLineDashStyle_DefaultValue
		{
			get;
			set;
		}
		...
		public ZAxisLabels Labels
		{
			get;
			set;
		}

		private ZAxisLabels Labels_DefaultValue
		{
			get;
			set;
		}
		...
		public ZAxisMinorGridLineDashStyle MinorGridLineDashStyle
		{
			get;
			set;
		}

		private ZAxisMinorGridLineDashStyle MinorGridLineDashStyle_DefaultValue
		{
			get;
			set;
		}
		...
		public ZAxisMinorTickPosition MinorTickPosition
		{
			get;
			set;
		}

		private ZAxisMinorTickPosition MinorTickPosition_DefaultValue
		{
			get;
			set;
		}
		...
		public ZAxisPlotBands PlotBands
		{
			get;
			set;
		}

		private ZAxisPlotBands PlotBands_DefaultValue
		{
			get;
			set;
		}

		public ZAxisPlotLines PlotLines
		{
			get;
			set;
		}

		private ZAxisPlotLines PlotLines_DefaultValue
		{
			get;
			set;
		}
		...
		public ZAxisTickmarkPlacement TickmarkPlacement
		{
			get;
			set;
		}

		private ZAxisTickmarkPlacement TickmarkPlacement_DefaultValue
		{
			get;
			set;
		}
		...
		public ZAxisTickPosition TickPosition
		{
			get;
			set;
		}

		private ZAxisTickPosition TickPosition_DefaultValue
		{
			get;
			set;
		}
		...
		public ZAxisTitle Title
		{
			get;
			set;
		}

		private ZAxisTitle Title_DefaultValue
		{
			get;
			set;
		}

		public ZAxisType Type
		{
			get;
			set;
		}

		private ZAxisType Type_DefaultValue
		{
			get;
			set;
		}
		...
		public ZAxis()
		{
			...
			this.ClassName = str;
			ZAxisCrosshair zAxisCrosshair = new ZAxisCrosshair();
			ZAxisCrosshair zAxisCrosshair1 = zAxisCrosshair;
			this.Crosshair_DefaultValue = zAxisCrosshair;
			this.Crosshair = zAxisCrosshair1;
			...
			ZAxisEvents zAxisEvent = new ZAxisEvents();
			ZAxisEvents zAxisEvent1 = zAxisEvent;
			this.Events_DefaultValue = zAxisEvent;
			this.Events = zAxisEvent1;
			nullable1 = null;
			...
			int num = 0;
			ZAxisGridLineDashStyle zAxisGridLineDashStyle = (ZAxisGridLineDashStyle)num;
			this.GridLineDashStyle_DefaultValue = (ZAxisGridLineDashStyle)num;
			this.GridLineDashStyle = zAxisGridLineDashStyle;
			...
			this.Id = str;
			ZAxisLabels zAxisLabel = new ZAxisLabels();
			ZAxisLabels zAxisLabel1 = zAxisLabel;
			this.Labels_DefaultValue = zAxisLabel;
			this.Labels = zAxisLabel1;
			string str4 = "#ccd6eb";
			str = str4;
			...
			int num1 = 0;
			ZAxisMinorGridLineDashStyle zAxisMinorGridLineDashStyle = (ZAxisMinorGridLineDashStyle)num1;
			this.MinorGridLineDashStyle_DefaultValue = (ZAxisMinorGridLineDashStyle)num1;
			this.MinorGridLineDashStyle = zAxisMinorGridLineDashStyle;
			nullable1 = new double?((double)1);
			...
			int num2 = 1;
			ZAxisMinorTickPosition zAxisMinorTickPosition = (ZAxisMinorTickPosition)num2;
			this.MinorTickPosition_DefaultValue = (ZAxisMinorTickPosition)num2;
			this.MinorTickPosition = zAxisMinorTickPosition;
			nullable1 = new double?(0);
			...
			ZAxisPlotBands zAxisPlotBand = new ZAxisPlotBands();
			ZAxisPlotBands zAxisPlotBand1 = zAxisPlotBand;
			this.PlotBands_DefaultValue = zAxisPlotBand;
			this.PlotBands = zAxisPlotBand1;
			ZAxisPlotLines zAxisPlotLine = new ZAxisPlotLines();
			ZAxisPlotLines zAxisPlotLine1 = zAxisPlotLine;
			this.PlotLines_DefaultValue = zAxisPlotLine;
			this.PlotLines = zAxisPlotLine1;
			nullable = new bool?(false);
			...
			int num3 = 1;
			ZAxisTickPosition zAxisTickPosition = (ZAxisTickPosition)num3;
			this.TickPosition_DefaultValue = (ZAxisTickPosition)num3;
			this.TickPosition = zAxisTickPosition;
			string str8 = "";
			str = str8;
			...
			int num4 = 0;
			ZAxisTickmarkPlacement zAxisTickmarkPlacement = (ZAxisTickmarkPlacement)num4;
			this.TickmarkPlacement_DefaultValue = (ZAxisTickmarkPlacement)num4;
			this.TickmarkPlacement = zAxisTickmarkPlacement;
			ZAxisTitle zAxisTitle = new ZAxisTitle();
			ZAxisTitle zAxisTitle1 = zAxisTitle;
			this.Title_DefaultValue = zAxisTitle;
			this.Title = zAxisTitle1;
			int num5 = 0;
			ZAxisType zAxisType = (ZAxisType)num5;
			this.Type_DefaultValue = (ZAxisType)num5;
			this.Type = zAxisType;
			nullable = new bool?(true);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				ZAxisGridLineDashStyle gridLineDashStyle = this.GridLineDashStyle;
			...
			{
				ZAxisMinorGridLineDashStyle minorGridLineDashStyle = this.MinorGridLineDashStyle;
			...
			{
				ZAxisMinorTickPosition minorTickPosition = this.MinorTickPosition;
			...
			{
				hashtables.Add("plotBands", this.PlotBands.ToHashtable());
			}
			if (this.PlotLines.IsDirty())
			{
				hashtables.Add("plotLines", this.PlotLines.ToHashtable());
			}
			...
			{
				ZAxisTickPosition tickPosition = this.TickPosition;
			...
			{
				ZAxisTickmarkPlacement tickmarkPlacement = this.TickmarkPlacement;
