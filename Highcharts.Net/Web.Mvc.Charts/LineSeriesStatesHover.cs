...
{
	public class LineSeriesStatesHover : BaseObject
	{
		...
		public LineSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private LineSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public LineSeriesStatesHover()
		{
			...
			LineSeriesStatesHoverHalo lineSeriesStatesHoverHalo = new LineSeriesStatesHoverHalo();
			LineSeriesStatesHoverHalo lineSeriesStatesHoverHalo1 = lineSeriesStatesHoverHalo;
			this.Halo_DefaultValue = lineSeriesStatesHoverHalo;
			this.Halo = lineSeriesStatesHoverHalo1;
