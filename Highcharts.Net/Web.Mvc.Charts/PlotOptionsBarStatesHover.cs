...
{
	public class PlotOptionsBarStatesHover : BaseObject
	{
		...
		public PlotOptionsBarStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsBarStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsBarStatesHover()
		{
			...
			PlotOptionsBarStatesHoverHalo plotOptionsBarStatesHoverHalo = new PlotOptionsBarStatesHoverHalo();
			PlotOptionsBarStatesHoverHalo plotOptionsBarStatesHoverHalo1 = plotOptionsBarStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsBarStatesHoverHalo;
			this.Halo = plotOptionsBarStatesHoverHalo1;
