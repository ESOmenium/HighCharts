...
namespace Highsoft.Web.Mvc.Charts
{
	...
	{
		public PlotOptionsAreaDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsAreaDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsAreaDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsAreaDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsAreaDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsAreaDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsAreaDataLabelsAlign plotOptionsAreaDataLabelsAlign = (PlotOptionsAreaDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsAreaDataLabelsAlign)num;
			this.Align = plotOptionsAreaDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsAreaDataLabelsOverflow plotOptionsAreaDataLabelsOverflow = (PlotOptionsAreaDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsAreaDataLabelsOverflow)num1;
			this.Overflow = plotOptionsAreaDataLabelsOverflow;
			...
			int num2 = 0;
			PlotOptionsAreaDataLabelsVerticalAlign plotOptionsAreaDataLabelsVerticalAlign = (PlotOptionsAreaDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PlotOptionsAreaDataLabelsVerticalAlign)num2;
			this.VerticalAlign = plotOptionsAreaDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsAreaDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsAreaDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsAreaDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsAreaDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
