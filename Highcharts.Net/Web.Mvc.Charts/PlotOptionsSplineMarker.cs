...
namespace Highsoft.Web.Mvc.Charts
{
	public class PlotOptionsSplineMarker : BaseObject
	{
		...
		public PlotOptionsSplineMarkerStates States
		{
			get;
			set;
		}

		private PlotOptionsSplineMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsSplineMarker()
		{
			...
			PlotOptionsSplineMarkerStates plotOptionsSplineMarkerState = new PlotOptionsSplineMarkerStates();
			PlotOptionsSplineMarkerStates plotOptionsSplineMarkerState1 = plotOptionsSplineMarkerState;
			this.States_DefaultValue = plotOptionsSplineMarkerState;
			this.States = plotOptionsSplineMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
