...
namespace Highsoft.Web.Mvc.Charts
{
	public class BoxplotSeriesData : BaseObject
	{
		...
		public BoxplotSeriesDataEvents Events
		{
			get;
			set;
		}

		private BoxplotSeriesDataEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		private double? Median_DefaultValue
		{
			get;
			set;
		}
		...
		private double? Q1_DefaultValue
		{
			get;
			set;
		}
		...
		private double? Q3_DefaultValue
		{
			get;
			set;
		}
		...
		public BoxplotSeriesData()
		{
			...
			this.Drilldown = str;
			BoxplotSeriesDataEvents boxplotSeriesDataEvent = new BoxplotSeriesDataEvents();
			BoxplotSeriesDataEvents boxplotSeriesDataEvent1 = boxplotSeriesDataEvent;
			this.Events_DefaultValue = boxplotSeriesDataEvent;
			this.Events = boxplotSeriesDataEvent1;
			nullable = null;
			...
			this.Low = nullable;
			nullable = null;
			this.Median_DefaultValue = nullable;
			this.Median = nullable;
			object obj4 = null;
			str = (string)obj4;
			this.Name_DefaultValue = (string)obj4;
			this.Name = str;
			nullable = null;
			this.Q1_DefaultValue = nullable;
			this.Q1 = nullable;
			nullable = null;
			this.Q3_DefaultValue = nullable;
			this.Q3 = nullable;
		...
		internal override Hashtable ToHashtable()
		{
			...
			colorIndex = this.Median;
			colorIndexDefaultValue = this.Median_DefaultValue;
			if ((colorIndex.GetValueOrDefault() == colorIndexDefaultValue.GetValueOrDefault() ? colorIndex.HasValue != colorIndexDefaultValue.HasValue : true))
			{
				hashtables.Add("median", this.Median);
			}
			if (this.Name != this.Name_DefaultValue)
			{
				hashtables.Add("name", this.Name);
			}
			colorIndexDefaultValue = this.Q1;
			colorIndex = this.Q1_DefaultValue;
			if ((colorIndexDefaultValue.GetValueOrDefault() == colorIndex.GetValueOrDefault() ? colorIndexDefaultValue.HasValue != colorIndex.HasValue : true))
			{
				hashtables.Add("q1", this.Q1);
			}
			colorIndex = this.Q3;
			colorIndexDefaultValue = this.Q3_DefaultValue;
			if ((colorIndex.GetValueOrDefault() == colorIndexDefaultValue.GetValueOrDefault() ? colorIndex.HasValue != colorIndexDefaultValue.HasValue : true))
			{
				hashtables.Add("q3", this.Q3);
			}
