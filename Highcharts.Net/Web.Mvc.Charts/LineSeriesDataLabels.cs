...
{
	public class LineSeriesDataLabels : BaseObject
	{
		public LineSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private LineSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public LineSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private LineSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public LineSeriesDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private LineSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			LineSeriesDataLabelsAlign lineSeriesDataLabelsAlign = (LineSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (LineSeriesDataLabelsAlign)num;
			this.Align = lineSeriesDataLabelsAlign;
			...
			int num1 = 0;
			LineSeriesDataLabelsOverflow lineSeriesDataLabelsOverflow = (LineSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (LineSeriesDataLabelsOverflow)num1;
			this.Overflow = lineSeriesDataLabelsOverflow;
			...
			int num2 = 0;
			LineSeriesDataLabelsVerticalAlign lineSeriesDataLabelsVerticalAlign = (LineSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (LineSeriesDataLabelsVerticalAlign)num2;
			this.VerticalAlign = lineSeriesDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				LineSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("LineSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				LineSeriesDataLabelsOverflow overflow = this.Overflow;
			...
			{
				LineSeriesDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
