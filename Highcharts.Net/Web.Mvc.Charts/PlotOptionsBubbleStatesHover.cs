...
{
	public class PlotOptionsBubbleStatesHover : BaseObject
	{
		...
		public PlotOptionsBubbleStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsBubbleStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsBubbleStatesHover()
		{
			...
			PlotOptionsBubbleStatesHoverHalo plotOptionsBubbleStatesHoverHalo = new PlotOptionsBubbleStatesHoverHalo();
			PlotOptionsBubbleStatesHoverHalo plotOptionsBubbleStatesHoverHalo1 = plotOptionsBubbleStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsBubbleStatesHoverHalo;
			this.Halo = plotOptionsBubbleStatesHoverHalo1;
