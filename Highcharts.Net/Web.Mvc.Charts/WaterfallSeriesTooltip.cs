...
{
	public class WaterfallSeriesTooltip : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("WaterfallSeriesTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
