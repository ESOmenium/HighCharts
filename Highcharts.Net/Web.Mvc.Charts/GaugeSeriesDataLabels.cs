...
{
	public class GaugeSeriesDataLabels : BaseObject
	{
		public GaugeSeriesDataLabelsAlign Align
		{
			get;
			set;
		}

		private GaugeSeriesDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public GaugeSeriesDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private GaugeSeriesDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			GaugeSeriesDataLabelsAlign gaugeSeriesDataLabelsAlign = (GaugeSeriesDataLabelsAlign)num;
			this.Align_DefaultValue = (GaugeSeriesDataLabelsAlign)num;
			this.Align = gaugeSeriesDataLabelsAlign;
			...
			int num1 = 0;
			GaugeSeriesDataLabelsOverflow gaugeSeriesDataLabelsOverflow = (GaugeSeriesDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (GaugeSeriesDataLabelsOverflow)num1;
			this.Overflow = gaugeSeriesDataLabelsOverflow;
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				GaugeSeriesDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("GaugeSeriesDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				GaugeSeriesDataLabelsOverflow overflow = this.Overflow;
