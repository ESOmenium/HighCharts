...
{
	public class PlotOptionsAreasplineTooltip : BaseObject
	{
		...
		public PlotOptionsAreasplineTooltip()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsAreasplineTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
