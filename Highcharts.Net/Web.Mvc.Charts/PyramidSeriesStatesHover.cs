...
{
	public class PyramidSeriesStatesHover : BaseObject
	{
		...
		public PyramidSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PyramidSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PyramidSeriesStatesHover()
		{
			...
			PyramidSeriesStatesHoverHalo pyramidSeriesStatesHoverHalo = new PyramidSeriesStatesHoverHalo();
			PyramidSeriesStatesHoverHalo pyramidSeriesStatesHoverHalo1 = pyramidSeriesStatesHoverHalo;
			this.Halo_DefaultValue = pyramidSeriesStatesHoverHalo;
			this.Halo = pyramidSeriesStatesHoverHalo1;
