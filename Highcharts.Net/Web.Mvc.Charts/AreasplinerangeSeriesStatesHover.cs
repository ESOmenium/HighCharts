...
{
	public class AreasplinerangeSeriesStatesHover : BaseObject
	{
		...
		public AreasplinerangeSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private AreasplinerangeSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public AreasplinerangeSeriesStatesHover()
		{
			...
			AreasplinerangeSeriesStatesHoverHalo areasplinerangeSeriesStatesHoverHalo = new AreasplinerangeSeriesStatesHoverHalo();
			AreasplinerangeSeriesStatesHoverHalo areasplinerangeSeriesStatesHoverHalo1 = areasplinerangeSeriesStatesHoverHalo;
			this.Halo_DefaultValue = areasplinerangeSeriesStatesHoverHalo;
			this.Halo = areasplinerangeSeriesStatesHoverHalo1;
