...
{
	public class AreasplineSeriesData : BaseObject
	{
		...
		public AreasplineSeriesDataEvents Events
		{
			get;
			set;
		}

		private AreasplineSeriesDataEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public AreasplineSeriesDataMarker Marker
		{
			get;
			set;
		}

		private AreasplineSeriesDataMarker Marker_DefaultValue
		{
			get;
			set;
		}
		...
		public AreasplineSeriesData()
		{
			...
			this.Drilldown = str;
			AreasplineSeriesDataEvents areasplineSeriesDataEvent = new AreasplineSeriesDataEvents();
			AreasplineSeriesDataEvents areasplineSeriesDataEvent1 = areasplineSeriesDataEvent;
			this.Events_DefaultValue = areasplineSeriesDataEvent;
			this.Events = areasplineSeriesDataEvent1;
			object obj3 = null;
			str = (string)obj3;
			...
			AreasplineSeriesDataMarker areasplineSeriesDataMarker = new AreasplineSeriesDataMarker();
			AreasplineSeriesDataMarker areasplineSeriesDataMarker1 = areasplineSeriesDataMarker;
			this.Marker_DefaultValue = areasplineSeriesDataMarker;
			this.Marker = areasplineSeriesDataMarker1;
			object obj4 = null;
			str = (string)obj4;
