...
{
	public class PlotOptionsScatterMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public PlotOptionsScatterMarkerStates States
		{
			get;
			set;
		}

		private PlotOptionsScatterMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsScatterMarker()
		{
			...
			PlotOptionsScatterMarkerStates plotOptionsScatterMarkerState = new PlotOptionsScatterMarkerStates();
			PlotOptionsScatterMarkerStates plotOptionsScatterMarkerState1 = plotOptionsScatterMarkerState;
			this.States_DefaultValue = plotOptionsScatterMarkerState;
			this.States = plotOptionsScatterMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
