...
namespace Highsoft.Web.Mvc.Charts
{
	public class PlotOptionsColumn : BaseObject
	{
		...
		public PlotOptionsColumnCursor Cursor
		{
			get;
			set;
		}

		private PlotOptionsColumnCursor Cursor_DefaultValue
		{
			get;
			set;
		}

		public PlotOptionsColumnDataLabels DataLabels
		{
			get;
			set;
		}

		private PlotOptionsColumnDataLabels DataLabels_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumnEvents Events
		{
			get;
			set;
		}

		private PlotOptionsColumnEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumnPoint Point
		{
			get;
			set;
		}

		private PlotOptionsColumnPoint Point_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumnPointIntervalUnit PointIntervalUnit
		{
			get;
			set;
		}

		private PlotOptionsColumnPointIntervalUnit PointIntervalUnit_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumnStacking Stacking
		{
			get;
			set;
		}

		private PlotOptionsColumnStacking Stacking_DefaultValue
		{
			get;
			set;
		}

		public PlotOptionsColumnStates States
		{
			get;
			set;
		}

		private PlotOptionsColumnStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumnTooltip Tooltip
		{
			get;
			set;
		}

		private PlotOptionsColumnTooltip Tooltip_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumnZones Zones
		{
			get;
			set;
		}

		private PlotOptionsColumnZones Zones_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumn()
		{
			...
			int num = 0;
			PlotOptionsColumnCursor plotOptionsColumnCursor = (PlotOptionsColumnCursor)num;
			this.Cursor_DefaultValue = (PlotOptionsColumnCursor)num;
			this.Cursor = plotOptionsColumnCursor;
			PlotOptionsColumnDataLabels plotOptionsColumnDataLabel = new PlotOptionsColumnDataLabels();
			PlotOptionsColumnDataLabels plotOptionsColumnDataLabel1 = plotOptionsColumnDataLabel;
			this.DataLabels_DefaultValue = plotOptionsColumnDataLabel;
			this.DataLabels = plotOptionsColumnDataLabel1;
			...
			PlotOptionsColumnEvents plotOptionsColumnEvent = new PlotOptionsColumnEvents();
			PlotOptionsColumnEvents plotOptionsColumnEvent1 = plotOptionsColumnEvent;
			this.Events_DefaultValue = plotOptionsColumnEvent;
			this.Events = plotOptionsColumnEvent1;
			nullable = new bool?(false);
			...
			PlotOptionsColumnPoint plotOptionsColumnPoint = new PlotOptionsColumnPoint();
			PlotOptionsColumnPoint plotOptionsColumnPoint1 = plotOptionsColumnPoint;
			this.Point_DefaultValue = plotOptionsColumnPoint;
			this.Point = plotOptionsColumnPoint1;
			nullable1 = new double?((double)1);
			this.PointInterval_DefaultValue = nullable1;
			this.PointInterval = nullable1;
			int num1 = 0;
			PlotOptionsColumnPointIntervalUnit plotOptionsColumnPointIntervalUnit = (PlotOptionsColumnPointIntervalUnit)num1;
			this.PointIntervalUnit_DefaultValue = (PlotOptionsColumnPointIntervalUnit)num1;
			this.PointIntervalUnit = plotOptionsColumnPointIntervalUnit;
			...
			int num2 = 0;
			PlotOptionsColumnStacking plotOptionsColumnStacking = (PlotOptionsColumnStacking)num2;
			this.Stacking_DefaultValue = (PlotOptionsColumnStacking)num2;
			this.Stacking = plotOptionsColumnStacking;
			PlotOptionsColumnStates plotOptionsColumnState = new PlotOptionsColumnStates();
			PlotOptionsColumnStates plotOptionsColumnState1 = plotOptionsColumnState;
			this.States_DefaultValue = plotOptionsColumnState;
			this.States = plotOptionsColumnState1;
			nullable = new bool?(true);
			...
			PlotOptionsColumnTooltip plotOptionsColumnTooltip = new PlotOptionsColumnTooltip();
			PlotOptionsColumnTooltip plotOptionsColumnTooltip1 = plotOptionsColumnTooltip;
			this.Tooltip_DefaultValue = plotOptionsColumnTooltip;
			this.Tooltip = plotOptionsColumnTooltip1;
			...
			this.ZoneAxis = str1;
			PlotOptionsColumnZones plotOptionsColumnZone = new PlotOptionsColumnZones();
			PlotOptionsColumnZones plotOptionsColumnZone1 = plotOptionsColumnZone;
			this.Zones_DefaultValue = plotOptionsColumnZone;
			this.Zones = plotOptionsColumnZone1;
		}
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsColumnCursor cursor = this.Cursor;
			...
			{
				PlotOptionsColumnPointIntervalUnit pointIntervalUnit = this.PointIntervalUnit;
			...
			{
				PlotOptionsColumnStacking stacking = this.Stacking;
