...
{
	public class PlotOptionsPolygonMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public PlotOptionsPolygonMarkerStates States
		{
			get;
			set;
		}

		private PlotOptionsPolygonMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsPolygonMarker()
		{
			...
			PlotOptionsPolygonMarkerStates plotOptionsPolygonMarkerState = new PlotOptionsPolygonMarkerStates();
			PlotOptionsPolygonMarkerStates plotOptionsPolygonMarkerState1 = plotOptionsPolygonMarkerState;
			this.States_DefaultValue = plotOptionsPolygonMarkerState;
			this.States = plotOptionsPolygonMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
