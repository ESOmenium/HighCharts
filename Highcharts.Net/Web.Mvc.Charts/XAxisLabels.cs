...
namespace Highsoft.Web.Mvc.Charts
{
	...
	{
		public XAxisLabelsAlign Align
		{
			get;
			set;
		}

		private XAxisLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 0;
			XAxisLabelsAlign xAxisLabelsAlign = (XAxisLabelsAlign)num;
			this.Align_DefaultValue = (XAxisLabelsAlign)num;
			this.Align = xAxisLabelsAlign;
