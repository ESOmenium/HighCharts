...
{
	public class PlotOptionsArearangeStatesHover : BaseObject
	{
		...
		public PlotOptionsArearangeStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsArearangeStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsArearangeStatesHover()
		{
			...
			PlotOptionsArearangeStatesHoverHalo plotOptionsArearangeStatesHoverHalo = new PlotOptionsArearangeStatesHoverHalo();
			PlotOptionsArearangeStatesHoverHalo plotOptionsArearangeStatesHoverHalo1 = plotOptionsArearangeStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsArearangeStatesHoverHalo;
			this.Halo = plotOptionsArearangeStatesHoverHalo1;
