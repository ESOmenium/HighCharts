...
{
	public class PlotOptionsColumnDataLabels : BaseObject
	{
		public PlotOptionsColumnDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsColumnDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumnDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsColumnDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsColumnDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsColumnDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsColumnDataLabelsAlign plotOptionsColumnDataLabelsAlign = (PlotOptionsColumnDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsColumnDataLabelsAlign)num;
			this.Align = plotOptionsColumnDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsColumnDataLabelsOverflow plotOptionsColumnDataLabelsOverflow = (PlotOptionsColumnDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsColumnDataLabelsOverflow)num1;
			this.Overflow = plotOptionsColumnDataLabelsOverflow;
			...
			int num2 = 0;
			PlotOptionsColumnDataLabelsVerticalAlign plotOptionsColumnDataLabelsVerticalAlign = (PlotOptionsColumnDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PlotOptionsColumnDataLabelsVerticalAlign)num2;
			this.VerticalAlign = plotOptionsColumnDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsColumnDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsColumnDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsColumnDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsColumnDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
