...
namespace Highsoft.Web.Mvc.Charts
{
	public class AreaSeries : Series
	{
		...
		public AreaSeriesCursor Cursor
		{
			get;
			set;
		}

		private AreaSeriesCursor Cursor_DefaultValue
		{
			get;
			set;
		}

		public AreaSeriesDashStyle DashStyle
		{
			get;
			set;
		}

		private AreaSeriesDashStyle DashStyle_DefaultValue
		{
			get;
			set;
		}

		public new List<AreaSeriesData> Data
		{
			get;
			set;
		}

		private List<AreaSeriesData> Data_DefaultValue
		{
			get;
			set;
		}

		public AreaSeriesDataLabels DataLabels
		{
			get;
			set;
		}

		private AreaSeriesDataLabels DataLabels_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesEvents Events
		{
			get;
			set;
		}

		private AreaSeriesEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesLinecap Linecap
		{
			get;
			set;
		}

		private AreaSeriesLinecap Linecap_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesMarker Marker
		{
			get;
			set;
		}

		private AreaSeriesMarker Marker_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesPoint Point
		{
			get;
			set;
		}

		private AreaSeriesPoint Point_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesPointIntervalUnit PointIntervalUnit
		{
			get;
			set;
		}

		private AreaSeriesPointIntervalUnit PointIntervalUnit_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesStacking Stacking
		{
			get;
			set;
		}

		private AreaSeriesStacking Stacking_DefaultValue
		{
			get;
			set;
		}

		public AreaSeriesStates States
		{
			get;
			set;
		}

		private AreaSeriesStates States_DefaultValue
		{
			get;
			set;
		}

		public AreaSeriesStep Step
		{
			get;
			set;
		}

		private AreaSeriesStep Step_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesTooltip Tooltip
		{
			get;
			set;
		}

		private AreaSeriesTooltip Tooltip_DefaultValue
		{
			get;
			set;
		}
		...
		public new AreaSeriesType Type
		{
			get;
			set;
		}

		private AreaSeriesType Type_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeriesZones Zones
		{
			get;
			set;
		}

		private AreaSeriesZones Zones_DefaultValue
		{
			get;
			set;
		}
		...
		public AreaSeries()
		{
			...
			int num = 0;
			AreaSeriesCursor areaSeriesCursor = (AreaSeriesCursor)num;
			this.Cursor_DefaultValue = (AreaSeriesCursor)num;
			this.Cursor = areaSeriesCursor;
			int num1 = 0;
			AreaSeriesDashStyle areaSeriesDashStyle = (AreaSeriesDashStyle)num1;
			this.DashStyle_DefaultValue = (AreaSeriesDashStyle)num1;
			this.DashStyle = areaSeriesDashStyle;
			List<AreaSeriesData> areaSeriesDatas = new List<AreaSeriesData>();
			List<AreaSeriesData> areaSeriesDatas1 = areaSeriesDatas;
			this.Data_DefaultValue = areaSeriesDatas;
			this.Data = areaSeriesDatas1;
			AreaSeriesDataLabels areaSeriesDataLabel = new AreaSeriesDataLabels();
			AreaSeriesDataLabels areaSeriesDataLabel1 = areaSeriesDataLabel;
			this.DataLabels_DefaultValue = areaSeriesDataLabel;
			this.DataLabels = areaSeriesDataLabel1;
			...
			AreaSeriesEvents areaSeriesEvent = new AreaSeriesEvents();
			AreaSeriesEvents areaSeriesEvent1 = areaSeriesEvent;
			this.Events_DefaultValue = areaSeriesEvent;
			this.Events = areaSeriesEvent1;
			object obj1 = null;
			object obj2 = obj1;
			...
			int num2 = 0;
			AreaSeriesLinecap areaSeriesLinecap = (AreaSeriesLinecap)num2;
			this.Linecap_DefaultValue = (AreaSeriesLinecap)num2;
			this.Linecap = areaSeriesLinecap;
			string str4 = "";
			str1 = str4;
			this.LinkedTo_DefaultValue = str4;
			this.LinkedTo = str1;
			AreaSeriesMarker areaSeriesMarker = new AreaSeriesMarker();
			AreaSeriesMarker areaSeriesMarker1 = areaSeriesMarker;
			this.Marker_DefaultValue = areaSeriesMarker;
			this.Marker = areaSeriesMarker1;
			object obj4 = null;
			str1 = (string)obj4;
			...
			AreaSeriesPoint areaSeriesPoint = new AreaSeriesPoint();
			AreaSeriesPoint areaSeriesPoint1 = areaSeriesPoint;
			this.Point_DefaultValue = areaSeriesPoint;
			this.Point = areaSeriesPoint1;
			nullable1 = new double?((double)1);
			this.PointInterval_DefaultValue = nullable1;
			this.PointInterval = nullable1;
			int num3 = 0;
			AreaSeriesPointIntervalUnit areaSeriesPointIntervalUnit = (AreaSeriesPointIntervalUnit)num3;
			this.PointIntervalUnit_DefaultValue = (AreaSeriesPointIntervalUnit)num3;
			this.PointIntervalUnit = areaSeriesPointIntervalUnit;
			...
			this.Stack = str1;
			int num4 = 0;
			AreaSeriesStacking areaSeriesStacking = (AreaSeriesStacking)num4;
			this.Stacking_DefaultValue = (AreaSeriesStacking)num4;
			this.Stacking = areaSeriesStacking;
			AreaSeriesStates areaSeriesState = new AreaSeriesStates();
			AreaSeriesStates areaSeriesState1 = areaSeriesState;
			this.States_DefaultValue = areaSeriesState;
			this.States = areaSeriesState1;
			int num5 = 0;
			AreaSeriesStep areaSeriesStep = (AreaSeriesStep)num5;
			this.Step_DefaultValue = (AreaSeriesStep)num5;
			this.Step = areaSeriesStep;
			nullable = new bool?(true);
			...
			AreaSeriesTooltip areaSeriesTooltip = new AreaSeriesTooltip();
			AreaSeriesTooltip areaSeriesTooltip1 = areaSeriesTooltip;
			this.Tooltip_DefaultValue = areaSeriesTooltip;
			this.Tooltip = areaSeriesTooltip1;
			nullable = new bool?(false);
			...
			int num6 = 0;
			AreaSeriesType areaSeriesType = (AreaSeriesType)num6;
			this.Type_DefaultValue = (AreaSeriesType)num6;
			this.Type = areaSeriesType;
			nullable = new bool?(true);
			...
			this.ZoneAxis = str1;
			AreaSeriesZones areaSeriesZone = new AreaSeriesZones();
			AreaSeriesZones areaSeriesZone1 = areaSeriesZone;
			this.Zones_DefaultValue = areaSeriesZone;
			this.Zones = areaSeriesZone1;
		}
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				AreaSeriesCursor cursor = this.Cursor;
				hashtables.Add("cursor", Highcharts.FirstCharacterToLower(cursor.ToString()));
			}
			if (this.DashStyle != this.DashStyle_DefaultValue)
			{
				AreaSeriesDashStyle dashStyle = this.DashStyle;
			...
			{
				AreaSeriesLinecap linecap = this.Linecap;
			...
			{
				AreaSeriesPointIntervalUnit pointIntervalUnit = this.PointIntervalUnit;
			...
			{
				AreaSeriesStacking stacking = this.Stacking;
