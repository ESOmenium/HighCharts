...
{
	public class ErrorbarSeriesStatesHover : BaseObject
	{
		...
		public ErrorbarSeriesStatesHoverHalo Halo
		{
			get;
			set;
		}

		private ErrorbarSeriesStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public ErrorbarSeriesStatesHover()
		{
			...
			ErrorbarSeriesStatesHoverHalo errorbarSeriesStatesHoverHalo = new ErrorbarSeriesStatesHoverHalo();
			ErrorbarSeriesStatesHoverHalo errorbarSeriesStatesHoverHalo1 = errorbarSeriesStatesHoverHalo;
			this.Halo_DefaultValue = errorbarSeriesStatesHoverHalo;
			this.Halo = errorbarSeriesStatesHoverHalo1;
