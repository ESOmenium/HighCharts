...
{
	public class LineSeriesDataMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public LineSeriesDataMarkerStates States
		{
			get;
			set;
		}

		private LineSeriesDataMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public LineSeriesDataMarker()
		{
			...
			LineSeriesDataMarkerStates lineSeriesDataMarkerState = new LineSeriesDataMarkerStates();
			LineSeriesDataMarkerStates lineSeriesDataMarkerState1 = lineSeriesDataMarkerState;
			this.States_DefaultValue = lineSeriesDataMarkerState;
			this.States = lineSeriesDataMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
