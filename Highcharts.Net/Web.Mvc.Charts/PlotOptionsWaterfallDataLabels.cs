...
{
	public class PlotOptionsWaterfallDataLabels : BaseObject
	{
		public PlotOptionsWaterfallDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsWaterfallDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsWaterfallDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsWaterfallDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsWaterfallDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsWaterfallDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsWaterfallDataLabelsAlign plotOptionsWaterfallDataLabelsAlign = (PlotOptionsWaterfallDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsWaterfallDataLabelsAlign)num;
			this.Align = plotOptionsWaterfallDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsWaterfallDataLabelsOverflow plotOptionsWaterfallDataLabelsOverflow = (PlotOptionsWaterfallDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsWaterfallDataLabelsOverflow)num1;
			this.Overflow = plotOptionsWaterfallDataLabelsOverflow;
			...
			int num2 = 0;
			PlotOptionsWaterfallDataLabelsVerticalAlign plotOptionsWaterfallDataLabelsVerticalAlign = (PlotOptionsWaterfallDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PlotOptionsWaterfallDataLabelsVerticalAlign)num2;
			this.VerticalAlign = plotOptionsWaterfallDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsWaterfallDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsWaterfallDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsWaterfallDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsWaterfallDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
