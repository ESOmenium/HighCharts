...
namespace Highsoft.Web.Mvc.Charts
{
	public class BubbleSeriesData : BaseObject
	{
		...
		public BubbleSeriesDataEvents Events
		{
			get;
			set;
		}

		private BubbleSeriesDataEvents Events_DefaultValue
		{
			get;
			set;
		}
		...
		public BubbleSeriesData()
		{
			...
			this.Drilldown = str;
			BubbleSeriesDataEvents bubbleSeriesDataEvent = new BubbleSeriesDataEvents();
			BubbleSeriesDataEvents bubbleSeriesDataEvent1 = bubbleSeriesDataEvent;
			this.Events_DefaultValue = bubbleSeriesDataEvent;
			this.Events = bubbleSeriesDataEvent1;
			object obj3 = null;
			str = (string)obj3;
		...
		internal override Hashtable ToHashtable()
		{
			...
			colorIndex = this.Z;
			colorIndexDefaultValue = this.Z_DefaultValue;
			if ((colorIndex.GetValueOrDefault() == colorIndexDefaultValue.GetValueOrDefault() ? colorIndex.HasValue != colorIndexDefaultValue.HasValue : true))
			{
				hashtables.Add("z", this.Z);
			}
			return hashtables;
		}
