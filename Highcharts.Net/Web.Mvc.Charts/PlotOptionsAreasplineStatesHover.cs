...
{
	public class PlotOptionsAreasplineStatesHover : BaseObject
	{
		...
		public PlotOptionsAreasplineStatesHoverHalo Halo
		{
			get;
			set;
		}

		private PlotOptionsAreasplineStatesHoverHalo Halo_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsAreasplineStatesHover()
		{
			...
			PlotOptionsAreasplineStatesHoverHalo plotOptionsAreasplineStatesHoverHalo = new PlotOptionsAreasplineStatesHoverHalo();
			PlotOptionsAreasplineStatesHoverHalo plotOptionsAreasplineStatesHoverHalo1 = plotOptionsAreasplineStatesHoverHalo;
			this.Halo_DefaultValue = plotOptionsAreasplineStatesHoverHalo;
			this.Halo = plotOptionsAreasplineStatesHoverHalo1;
