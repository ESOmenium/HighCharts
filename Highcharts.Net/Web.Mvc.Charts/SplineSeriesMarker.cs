...
{
	public class SplineSeriesMarker : BaseObject
	{
		public bool? Enabled
		{
			get;
		...
		public SplineSeriesMarkerStates States
		{
			get;
			set;
		}

		private SplineSeriesMarkerStates States_DefaultValue
		{
			get;
			set;
		}
		...
		public SplineSeriesMarker()
		{
			...
			SplineSeriesMarkerStates splineSeriesMarkerState = new SplineSeriesMarkerStates();
			SplineSeriesMarkerStates splineSeriesMarkerState1 = splineSeriesMarkerState;
			this.States_DefaultValue = splineSeriesMarkerState;
			this.States = splineSeriesMarkerState1;
			object obj2 = null;
			str1 = (string)obj2;
