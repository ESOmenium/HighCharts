...
{
	public class PlotOptionsSolidgaugeTooltip : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (this.PointFormatter != this.PointFormatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsSolidgaugeTooltipPointFormatter.pointFormatter", this.PointFormatter);
			}
