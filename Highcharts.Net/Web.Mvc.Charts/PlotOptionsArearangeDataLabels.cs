...
namespace Highsoft.Web.Mvc.Charts
{
	...
	{
		public PlotOptionsArearangeDataLabelsAlign Align
		{
			get;
			set;
		}

		private PlotOptionsArearangeDataLabelsAlign Align_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsArearangeDataLabelsOverflow Overflow
		{
			get;
			set;
		}

		private PlotOptionsArearangeDataLabelsOverflow Overflow_DefaultValue
		{
			get;
			set;
		}
		...
		public PlotOptionsArearangeDataLabelsVerticalAlign VerticalAlign
		{
			get;
			set;
		}

		private PlotOptionsArearangeDataLabelsVerticalAlign VerticalAlign_DefaultValue
		{
			get;
			set;
		}
		...
		{
			int num = 1;
			PlotOptionsArearangeDataLabelsAlign plotOptionsArearangeDataLabelsAlign = (PlotOptionsArearangeDataLabelsAlign)num;
			this.Align_DefaultValue = (PlotOptionsArearangeDataLabelsAlign)num;
			this.Align = plotOptionsArearangeDataLabelsAlign;
			...
			int num1 = 0;
			PlotOptionsArearangeDataLabelsOverflow plotOptionsArearangeDataLabelsOverflow = (PlotOptionsArearangeDataLabelsOverflow)num1;
			this.Overflow_DefaultValue = (PlotOptionsArearangeDataLabelsOverflow)num1;
			this.Overflow = plotOptionsArearangeDataLabelsOverflow;
			...
			int num2 = 0;
			PlotOptionsArearangeDataLabelsVerticalAlign plotOptionsArearangeDataLabelsVerticalAlign = (PlotOptionsArearangeDataLabelsVerticalAlign)num2;
			this.VerticalAlign_DefaultValue = (PlotOptionsArearangeDataLabelsVerticalAlign)num2;
			this.VerticalAlign = plotOptionsArearangeDataLabelsVerticalAlign;
			nullable1 = new double?(0);
		...
		internal override Hashtable ToHashtable()
		{
			...
			{
				PlotOptionsArearangeDataLabelsAlign align = this.Align;
			...
			if (this.Formatter != this.Formatter_DefaultValue)
			{
				...
				Highcharts.AddFunction("PlotOptionsArearangeDataLabelsFormatter.formatter", this.Formatter);
			}
			...
			{
				PlotOptionsArearangeDataLabelsOverflow overflow = this.Overflow;
			...
			{
				PlotOptionsArearangeDataLabelsVerticalAlign verticalAlign = this.VerticalAlign;
